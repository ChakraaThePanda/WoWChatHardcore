...
implements Serializable {
    ...
    public int hashCode() {
        int result2 = this.first == null ? 0 : this.first.hashCode();
        result2 = result2 * 31 + (this.second == null ? 0 : this.second.hashCode());
        result2 = result2 * 31 + (this.third == null ? 0 : this.third.hashCode());
        return result2;
    }
