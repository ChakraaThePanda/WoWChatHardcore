...
public final class UStringsKt {
    ...
    public static final UInt toUIntOrNull(@NotNull String $this$toUIntOrNull, int radix) {
        ...
        for (int i = start; i < length; ++i) {
            ...
            if (Integer.compareUnsigned(result2, limitBeforeMul) > 0) {
            ...
            int beforeAdding = result2 = UInt.constructor-impl(result2 * uradix);
            if (Integer.compareUnsigned(result2 = UInt.constructor-impl(result2 + UInt.constructor-impl(digit)), beforeAdding) >= 0) continue;
            return null;
        }
    ...
    public static final ULong toULongOrNull(@NotNull String $this$toULongOrNull, int radix) {
        ...
        for (int i = start; i < length; ++i) {
            ...
            if (Long.compareUnsigned(result2, limitBeforeMul) > 0) {
                if (limitBeforeMul == limitForMaxRadix) {
            ...
            long beforeAdding = result2 = ULong.constructor-impl(result2 * uradix);
            int n = UInt.constructor-impl(digit);
            if (Long.compareUnsigned(result2 = ULong.constructor-impl(result2 + ULong.constructor-impl((long)n & 0xFFFFFFFFL)), beforeAdding) >= 0) continue;
            return null;
        }
