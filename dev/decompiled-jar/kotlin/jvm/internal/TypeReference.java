...
implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        String result2 = klass + args2 + nullable;
        KType upper = this.platformTypeUpperBound;
        return upper instanceof TypeReference ? (Intrinsics.areEqual(renderedUpper = ((TypeReference)upper).asString(true), result2) ? result2 : (Intrinsics.areEqual(renderedUpper, result2 + '?') ? result2 + '!' : '(' + result2 + ".." + renderedUpper + ')')) : result2;
    }
