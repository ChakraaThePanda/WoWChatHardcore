...
Externalizable {
    ...
    public TDoubleByteHashMap(double[] keys2, byte[] values2) {
    ...
    public TDoubleByteHashMap(TDoubleByteMap map) {
        ...
        if (map instanceof TDoubleByteHashMap) {
            ...
            this.setUp(TDoubleByteHashMap.saturatedCast(TDoubleByteHashMap.fastCeil(10.0 / (double)this._loadFactor)));
        }
        this.putAll(map);
    }
    ...
    implements TByteCollection {
        ...
        public boolean remove(byte entry) {
            byte[] values2 = TDoubleByteHashMap.this._values;
