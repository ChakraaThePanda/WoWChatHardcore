...
Externalizable {
    ...
    public TByteCharHashMap(byte[] keys2, char[] values2) {
    ...
    public TByteCharHashMap(TByteCharMap map) {
        ...
        if (map instanceof TByteCharHashMap) {
            ...
            this.setUp(TByteCharHashMap.saturatedCast(TByteCharHashMap.fastCeil(10.0 / (double)this._loadFactor)));
        }
        this.putAll(map);
    }
    ...
    implements TCharCollection {
        ...
        public boolean remove(char entry) {
            char[] values2 = TByteCharHashMap.this._values;
