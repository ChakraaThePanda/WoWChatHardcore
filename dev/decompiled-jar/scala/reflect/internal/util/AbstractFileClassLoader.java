...
implements ScalaClassLoader {
    ...
    public AbstractFile findAbstractFile(String name) {
        ...
        return AbstractFileClassLoader$.MODULE$.lookupPath(this.root(), Predef$.MODULE$.wrapRefArray((Object[])new StringOps(name).split('/')), false);
    }
    ...
    public AbstractFile findAbstractDir(String name) {
        ...
        try {
            ...
            String string = this.dirNameToPath(name);
            if (Predef$.MODULE$ == null) {
                throw null;
            }
            String[] pathParts = new StringOps(string).split('/');
            ArrayOps.ofRef<Object> foreach_this = new ArrayOps.ofRef<Object>(Predef$.MODULE$.refArrayOps((Object[])pathParts));
            ...
            for (int foreach_i = 0; foreach_i < foreach_len; ++foreach_i) {
                ...
                AbstractFileClassLoader.$anonfun$findAbstractDir$1(file, object, string2);
            }
            return (AbstractFile)file.elem;
        }
    ...
    public URL findResource(String name) {
        ...
        URL uRL = abstractFile == null ? null : new URL(null, new StringBuilder(7).append("memory:").append(abstractFile.path()).toString(), new URLStreamHandler(null, abstractFile){
    ...
    private ProtectionDomain protectionDomain$lzycompute() {
        block7: {
            synchronized (this) {
                ...
                resource = Thread.currentThread().getContextClassLoader().getResource("scala/runtime/package.class");
                if (resource == null) ** GOTO lbl-1000
                v0 = resource.getProtocol();
                var2_2 = "jar";
                if (v0 == null || !v0.equals(var2_2)) lbl-1000:
                // 2 sources
    ...
    public ProtectionDomain protectionDomain() {
        if (!this.bitmap$0) {
            return this.protectionDomain$lzycompute();
        }
        return this.protectionDomain;
    }
    ...
    public Package getPackage(String name) {
        Package package_ = this.findAbstractDir(name) == null ? super.getPackage(name) : (Package)this.packages.getOrElseUpdate(name, (Function0<Package> & java.io.Serializable & Serializable)() -> {
    ...
    public Package[] getPackages() {
        return (Package[])this.root().iterator().filter((Function1<AbstractFile, Object> & java.io.Serializable & Serializable)x$1 -> BoxesRunTime.boxToBoolean(x$1.isDirectory())).map((Function1<AbstractFile, Package> & java.io.Serializable & Serializable)dir -> this.getPackage(dir.name())).toArray(ClassTag$.MODULE$.apply(Package.class));
    }

    public static final /* synthetic */ void $anonfun$findAbstractDir$1(ObjectRef file$2, Object nonLocalReturnKey2$1, String dirPart) {
        file$2.elem = ((AbstractFile)file$2.elem).lookupName(dirPart, true);
        if ((AbstractFile)file$2.elem == null) {
            throw new NonLocalReturnControl<Object>(nonLocalReturnKey2$1, null);
        }
    }
    ...
    public static final /* synthetic */ Object $anonfun$findAbstractDir$1$adapted(ObjectRef file$2, Object nonLocalReturnKey2$1, String dirPart) {
        AbstractFileClassLoader.$anonfun$findAbstractDir$1(file$2, nonLocalReturnKey2$1, dirPart);
