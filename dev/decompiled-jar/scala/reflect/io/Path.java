...
public class Path {
    ...
    public Path $div(Path child) {
        ...
        return new Path(new java.io.File(this.jfile(), child.path()));
    }
    ...
    public Iterator<Path> walk() {
        return this.walkFilter((Function1<Path, Object> & java.io.Serializable & Serializable)x$7 -> BoxesRunTime.boxToBoolean(Path.$anonfun$walk$1(x$7)));
    }
    ...
    public Path resolve(Path other) {
        if (other.isAbsolute() || this.isEmpty()) {
            return other;
        }
    ...
    public Path relativize(Path other) {
        ...
        boolean bl;
        boolean bl2 = bl = this.isAbsolute() == other.isAbsolute();
        if (Predef$.MODULE$ == null) {
            throw null;
        }
        if (assert_assertion == false) {
            throw new AssertionError((Object)new StringBuilder(18).append("assertion failed: ").append((Object)Path.$anonfun$relativize$1(this, other)).toString());
        }
    ...
    public List<String> segments() {
        ...
        return (List)new ArrayOps.ofRef<Object>(Predef$.MODULE$.refArrayOps((Object[])new StringOps(string).split(this.separator()))).toList().filterNot((Function1<String, Object> & java.io.Serializable & Serializable)x$8 -> BoxesRunTime.boxToBoolean(Path.$anonfun$segments$1(x$8)));
    }
    ...
    public Directory parent() {
        block3: {
            block2: {
                var4_1 = this.path();
                var3_2 = "".equals(var4_1) != false ? true : ".".equals(var4_1) != false;
                if (!var3_2) break block2;
                var1_3 = Directory$.MODULE$.apply(Path$.MODULE$.string2path(".."));
                break block3;
            }
            ...
            {
                var2_6 = (var6_5 = this.jfile().getParent()) == null ? (this.isAbsolute() != false ? this.toDirectory() : Directory$.MODULE$.apply(Path$.MODULE$.string2path("."))) : Directory$.MODULE$.apply(Path$.MODULE$.string2path(var6_5));
                v1 = var2_6;
            }
            var1_3 = v1;
        }
    ...
    public boolean hasExtension(String ext, Seq<String> exts) {
        ...
        return !(string == null ? lower != null : !string.equals(lower)) || exts.exists((Function1<String, Object> & java.io.Serializable & Serializable)x$10 -> BoxesRunTime.boxToBoolean(Path.$anonfun$hasExtension$1(lower, x$10)));
    }
    ...
    public String stripExtension() {
        ...
        return new StringOps(string).stripSuffix(new StringBuilder(1).append(".").append(this.extension()).toString());
    }
    ...
    public Path changeExtension(String ext) {
        ...
        return Path$.MODULE$.apply(new StringBuilder(0).append(new StringOps(string3).stripSuffix(this.extension())).append(ext).toString());
    }

    public <T> Option<T> ifFile(Function1<File, T> f) {
        if (this.isFile()) {
            return new Some<T>(f.apply(this.toFile()));
        }
        return None$.MODULE$;
    }
    ...
    public <T> Option<T> ifDirectory(Function1<Directory, T> f) {
        if (this.isDirectory()) {
            return new Some<T>(f.apply(this.toDirectory()));
        }
        return None$.MODULE$;
    }
    ...
    public Directory createDirectory(boolean force, boolean failIfExists) {
        if (!(force ? this.jfile().mkdirs() : this.jfile().mkdir()) && failIfExists && this.exists()) {
            ...
            throw Path$.MODULE$.fail(new StringOps(string).format(Predef$.MODULE$.genericWrapArray(new Object[]{this.name()})));
        }
        if (this.isDirectory()) {
    ...
    private boolean deleteRecursively(java.io.File f) {
        ...
        if (f.isDirectory() && (fileArray = f.listFiles()) != null) {
            ArrayOps.ofRef<Object> foreach_this = new ArrayOps.ofRef<Object>(Predef$.MODULE$.refArrayOps((Object[])fileArray));
            int foreach_len = foreach_this.length();
            for (int foreach_i = 0; foreach_i < foreach_len; ++foreach_i) {
                java.io.File file = (java.io.File)foreach_this.apply(foreach_i);
    ...
    public static final /* synthetic */ boolean $anonfun$walk$1(Path x$7) {
        return true;
    }

    public static final /* synthetic */ String $anonfun$relativize$1(Path $this, Path other$1) {
    ...
    private final String createRelativePath$1(List baseSegs, List otherSegs) {
        while (true) {
            List list = baseSegs;
            List list2 = otherSegs;
            if (!(list instanceof $colon$colon)) break;
            $colon$colon $colon$colon = ($colon$colon)list;
            String b = (String)$colon$colon.head();
            List bs = $colon$colon.tl$access$1();
            if (!(list2 instanceof $colon$colon)) break;
            $colon$colon $colon$colon2 = ($colon$colon)list2;
            String o = (String)$colon$colon2.head();
            List os = $colon$colon2.tl$access$1();
            String string = b;
            if (string != null ? !string.equals(o) : o != null) break;
            otherSegs = os;
            baseSegs = bs;
        }
        List bs = baseSegs;
        List os = otherSegs;
        String string = new StringBuilder(2).append("..").append(this.separator()).toString();
        if (Predef$.MODULE$ == null) {
            throw null;
        }
        return new StringBuilder(0).append(new StringOps(string).$times(bs.length())).append(os.mkString(this.separatorStr())).toString();
    }

    public static final /* synthetic */ boolean $anonfun$segments$1(String x$8) {
        return x$8.length() == 0;
    }

    public static final /* synthetic */ boolean $anonfun$hasExtension$1(String lower$1, String x$10) {
        String string = x$10.toLowerCase();
        return !(string != null ? !string.equals(lower$1) : lower$1 != null);
    }
    ...
    public static final /* synthetic */ Object $anonfun$deleteRecursively$1$adapted(Path $this, java.io.File f) {
        return BoxesRunTime.boxToBoolean($this.deleteRecursively(f));
    }
}
