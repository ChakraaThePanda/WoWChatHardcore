...
implements Streamable.Chars {
    ...
    public Iterator<Path> walkFilter(Function1<Path, Object> cond) {
        if (BoxesRunTime.unboxToBoolean(cond.apply(this))) {
            return package$.MODULE$.Iterator().single(this);
        }
    ...
    public void writeAll(Seq<String> strings) {
        try (BufferedWriter out = this.bufferedWriter();){
            strings.foreach((Function1<String, Object> & java.io.Serializable & Serializable)x$1 -> {
                out.write(x$1);
    ...
    public void appendAll(Seq<String> strings) {
        try (BufferedWriter out = this.bufferedWriter(true);){
            strings.foreach((Function1<String, Object> & java.io.Serializable & Serializable)x$2 -> {
                out.write(x$2);
                return BoxedUnit.UNIT;
            });
        }
    ...
    public void printlnAll(Seq<String> strings) {
        try (PrintWriter out = this.printWriter();){
            strings.foreach((Function1<String, Object> & java.io.Serializable & Serializable)x$3 -> {
                out.println(x$3);
                return BoxedUnit.UNIT;
            });
        }
    ...
    public Option<String> safeSlurp() {
        try {
            return new Some<String>(this.slurp());
        }
    ...
    public boolean setExecutable(boolean executable, boolean ownerOnly) {
        ...
        try {
            return (Boolean)method.invoke(super.jfile(), Predef$.MODULE$.boolean2Boolean(executable), Predef$.MODULE$.boolean2Boolean(ownerOnly));
        }
