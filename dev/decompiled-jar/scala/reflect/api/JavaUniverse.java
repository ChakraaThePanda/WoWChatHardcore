...
public interface JavaUniverse {
    ...
    public static void $init$(JavaUniverse $this) {
        $this.scala$reflect$api$JavaUniverse$_setter_$RuntimeClassTag_$eq(ClassTag$.MODULE$.apply(Class.class));
    }
    ...
    extends Mirrors.RuntimeMirror {
        ...
        public static /* synthetic */ String toString$(JavaMirror $this) {
        ...
        public static void $init$(JavaMirror $this) {
        }
    }
}
