...
AdaptiveWorkStealingForkJoinTasks {
    ...
    public <R, Tp> R executeAndWaitResult(Task<R, Tp> task) {
        return (R)ForkJoinTasks.executeAndWaitResult$(this, task);
    }
