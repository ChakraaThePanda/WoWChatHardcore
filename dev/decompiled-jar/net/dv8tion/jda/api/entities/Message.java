...
Formattable {
    ...
    @Nonnull
    @CheckReturnValue
    default public MessageCreateAction replyFiles(FileUpload ... files2) {
        return this.getChannel().sendFiles(files2).setMessageReference(this);
    }

    @Nonnull
    @CheckReturnValue
    default public MessageCreateAction replyFiles(@Nonnull Collection<? extends FileUpload> files2) {
        return this.getChannel().sendFiles(files2).setMessageReference(this);
    }
