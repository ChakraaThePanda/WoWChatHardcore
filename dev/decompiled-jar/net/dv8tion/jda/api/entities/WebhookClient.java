...
extends ISnowflake {
    ...
    @Nonnull
    @CheckReturnValue
    default public WebhookMessageCreateAction<T> sendFiles(FileUpload ... files2) {
        Checks.noneNull(files2, "Files");
        Checks.notEmpty(files2, "Files");
    ...
    @Nonnull
    public static IncomingWebhookClient createClient(@Nonnull JDA api2, @Nonnull String url) {
        ...
        return WebhookClient.createClient(api2, id, token);
    }

    @Nonnull
    public static IncomingWebhookClient createClient(@Nonnull JDA api2, @Nonnull String webhookId, @Nonnull String webhookToken) {
        Checks.notNull(api2, "JDA");
        Checks.notBlank(webhookToken, "Token");
        return new IncomingWebhookClientImpl(MiscUtil.parseSnowflake(webhookId), webhookToken, api2);
    }
}
