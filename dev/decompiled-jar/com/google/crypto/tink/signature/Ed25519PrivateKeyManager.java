...
public final class Ed25519PrivateKeyManager {
    ...
    private static final MutableKeyCreationRegistry.KeyCreator<Ed25519Parameters> KEY_CREATOR = Ed25519PrivateKeyManager::createEd25519Key;
    ...
    private static Map<String, Parameters> namedParameters() throws GeneralSecurityException {
        HashMap<String, Ed25519Parameters> result2 = new HashMap<String, Ed25519Parameters>();
        result2.put("ED25519", Ed25519Parameters.create(Ed25519Parameters.Variant.TINK));
        result2.put("ED25519_RAW", Ed25519Parameters.create(Ed25519Parameters.Variant.NO_PREFIX));
        result2.put("ED25519WithRawOutput", Ed25519Parameters.create(Ed25519Parameters.Variant.NO_PREFIX));
