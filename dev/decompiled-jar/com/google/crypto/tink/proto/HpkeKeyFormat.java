...
implements HpkeKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HpkeKeyFormat.class.getName());
    ...
    implements HpkeKeyFormatOrBuilder {
        ...
        public HpkeKeyFormat build() {
            HpkeKeyFormat result2 = this.buildPartial();
        ...
        public HpkeKeyFormat buildPartial() {
            HpkeKeyFormat result2 = new HpkeKeyFormat(this);
        ...
        private void buildPartial0(HpkeKeyFormat result2) {
