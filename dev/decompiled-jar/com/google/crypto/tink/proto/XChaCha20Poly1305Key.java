...
implements XChaCha20Poly1305KeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", XChaCha20Poly1305Key.class.getName());
    ...
    implements XChaCha20Poly1305KeyOrBuilder {
        ...
        public XChaCha20Poly1305Key build() {
            XChaCha20Poly1305Key result2 = this.buildPartial();
        ...
        public XChaCha20Poly1305Key buildPartial() {
            XChaCha20Poly1305Key result2 = new XChaCha20Poly1305Key(this);
        ...
        private void buildPartial0(XChaCha20Poly1305Key result2) {
