...
implements HpkeParamsOrBuilder {
    ...
    public HpkeKem getKem() {
        HpkeKem result2 = HpkeKem.forNumber(this.kem_);
        return result2 == null ? HpkeKem.UNRECOGNIZED : result2;
    }
    ...
    public HpkeKdf getKdf() {
        HpkeKdf result2 = HpkeKdf.forNumber(this.kdf_);
        return result2 == null ? HpkeKdf.UNRECOGNIZED : result2;
    }
    ...
    public HpkeAead getAead() {
        HpkeAead result2 = HpkeAead.forNumber(this.aead_);
        return result2 == null ? HpkeAead.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HpkeParams.class.getName());
    ...
    implements HpkeParamsOrBuilder {
        ...
        public HpkeParams build() {
            HpkeParams result2 = this.buildPartial();
        ...
        public HpkeParams buildPartial() {
            HpkeParams result2 = new HpkeParams(this);
        ...
        private void buildPartial0(HpkeParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.kem_ = this.kem_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.kdf_ = this.kdf_;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.aead_ = this.aead_;
            }
        }
