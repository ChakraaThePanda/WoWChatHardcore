...
implements KmsAeadKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KmsAeadKeyFormat.class.getName());
    ...
    implements KmsAeadKeyFormatOrBuilder {
        ...
        public KmsAeadKeyFormat build() {
            KmsAeadKeyFormat result2 = this.buildPartial();
        ...
        public KmsAeadKeyFormat buildPartial() {
            KmsAeadKeyFormat result2 = new KmsAeadKeyFormat(this);
        ...
        private void buildPartial0(KmsAeadKeyFormat result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.keyUri_ = this.keyUri_;
            }
        }
