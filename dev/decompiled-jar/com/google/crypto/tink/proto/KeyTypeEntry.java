...
implements KeyTypeEntryOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KeyTypeEntry.class.getName());
    ...
    implements KeyTypeEntryOrBuilder {
        ...
        public KeyTypeEntry build() {
            KeyTypeEntry result2 = this.buildPartial();
        ...
        public KeyTypeEntry buildPartial() {
            KeyTypeEntry result2 = new KeyTypeEntry(this);
        ...
        private void buildPartial0(KeyTypeEntry result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.primitiveName_ = this.primitiveName_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.typeUrl_ = this.typeUrl_;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.keyManagerVersion_ = this.keyManagerVersion_;
            }
            if ((from_bitField0_ & 8) != 0) {
                result2.newKeyAllowed_ = this.newKeyAllowed_;
            }
            if ((from_bitField0_ & 0x10) != 0) {
                result2.catalogueName_ = this.catalogueName_;
            }
        }
