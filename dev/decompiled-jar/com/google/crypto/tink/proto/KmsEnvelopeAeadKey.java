...
implements KmsEnvelopeAeadKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KmsEnvelopeAeadKey.class.getName());
    ...
    implements KmsEnvelopeAeadKeyOrBuilder {
        ...
        public KmsEnvelopeAeadKey build() {
            KmsEnvelopeAeadKey result2 = this.buildPartial();
        ...
        public KmsEnvelopeAeadKey buildPartial() {
            KmsEnvelopeAeadKey result2 = new KmsEnvelopeAeadKey(this);
        ...
        private void buildPartial0(KmsEnvelopeAeadKey result2) {
        ...
        private SingleFieldBuilder<KmsEnvelopeAeadKeyFormat, KmsEnvelopeAeadKeyFormat.Builder, KmsEnvelopeAeadKeyFormatOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
