...
implements RsaSsaPssParamsOrBuilder {
    ...
    public HashType getSigHash() {
        HashType result2 = HashType.forNumber(this.sigHash_);
    ...
    public HashType getMgf1Hash() {
        HashType result2 = HashType.forNumber(this.mgf1Hash_);
        return result2 == null ? HashType.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPssParams.class.getName());
    ...
    implements RsaSsaPssParamsOrBuilder {
        ...
        public RsaSsaPssParams build() {
            RsaSsaPssParams result2 = this.buildPartial();
        ...
        public RsaSsaPssParams buildPartial() {
            RsaSsaPssParams result2 = new RsaSsaPssParams(this);
        ...
        private void buildPartial0(RsaSsaPssParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.sigHash_ = this.sigHash_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.mgf1Hash_ = this.mgf1Hash_;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.saltLength_ = this.saltLength_;
            }
        }
