...
implements AesCmacKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCmacKey.class.getName());
    ...
    implements AesCmacKeyOrBuilder {
        ...
        public AesCmacKey build() {
            AesCmacKey result2 = this.buildPartial();
        ...
        public AesCmacKey buildPartial() {
            AesCmacKey result2 = new AesCmacKey(this);
        ...
        private void buildPartial0(AesCmacKey result2) {
