...
implements KeyDataOrBuilder {
    ...
    public KeyMaterialType getKeyMaterialType() {
        KeyMaterialType result2 = KeyMaterialType.forNumber(this.keyMaterialType_);
        return result2 == null ? KeyMaterialType.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KeyData.class.getName());
    ...
    implements KeyDataOrBuilder {
        ...
        public KeyData build() {
            KeyData result2 = this.buildPartial();
        ...
        public KeyData buildPartial() {
            KeyData result2 = new KeyData(this);
        ...
        private void buildPartial0(KeyData result2) {
            ...
            if ((from_bitField0_ & 4) != 0) {
                result2.keyMaterialType_ = this.keyMaterialType_;
            }
        }
    ...
    public static enum KeyMaterialType implements ProtocolMessageEnum
    {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KeyMaterialType.class.getName());
