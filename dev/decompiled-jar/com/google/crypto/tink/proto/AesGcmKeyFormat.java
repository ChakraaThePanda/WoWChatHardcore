...
implements AesGcmKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesGcmKeyFormat.class.getName());
    ...
    implements AesGcmKeyFormatOrBuilder {
        ...
        public AesGcmKeyFormat build() {
            AesGcmKeyFormat result2 = this.buildPartial();
        ...
        public AesGcmKeyFormat buildPartial() {
            AesGcmKeyFormat result2 = new AesGcmKeyFormat(this);
        ...
        private void buildPartial0(AesGcmKeyFormat result2) {
