...
implements AesCmacPrfKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCmacPrfKeyFormat.class.getName());
    ...
    implements AesCmacPrfKeyFormatOrBuilder {
        ...
        public AesCmacPrfKeyFormat build() {
            AesCmacPrfKeyFormat result2 = this.buildPartial();
        ...
        public AesCmacPrfKeyFormat buildPartial() {
            AesCmacPrfKeyFormat result2 = new AesCmacPrfKeyFormat(this);
        ...
        private void buildPartial0(AesCmacPrfKeyFormat result2) {
