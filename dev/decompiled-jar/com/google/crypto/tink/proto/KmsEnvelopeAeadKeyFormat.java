...
implements KmsEnvelopeAeadKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KmsEnvelopeAeadKeyFormat.class.getName());
    ...
    implements KmsEnvelopeAeadKeyFormatOrBuilder {
        ...
        public KmsEnvelopeAeadKeyFormat build() {
            KmsEnvelopeAeadKeyFormat result2 = this.buildPartial();
        ...
        public KmsEnvelopeAeadKeyFormat buildPartial() {
            KmsEnvelopeAeadKeyFormat result2 = new KmsEnvelopeAeadKeyFormat(this);
        ...
        private void buildPartial0(KmsEnvelopeAeadKeyFormat result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.kekUri_ = this.kekUri_;
            }
            int to_bitField0_ = 0;
            if ((from_bitField0_ & 2) != 0) {
                result2.dekTemplate_ = this.dekTemplateBuilder_ == null ? this.dekTemplate_ : this.dekTemplateBuilder_.build();
                to_bitField0_ |= 1;
            }
        ...
        public KeyTemplate.Builder getDekTemplateBuilder() {
            this.bitField0_ |= 2;
            this.onChanged();
            return this.getDekTemplateFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<KeyTemplate, KeyTemplate.Builder, KeyTemplateOrBuilder> getDekTemplateFieldBuilder() {
            if (this.dekTemplateBuilder_ == null) {
