...
implements JwtRsaSsaPssKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtRsaSsaPssKeyFormat.class.getName());
    ...
    implements JwtRsaSsaPssKeyFormatOrBuilder {
        ...
        public JwtRsaSsaPssKeyFormat build() {
            JwtRsaSsaPssKeyFormat result2 = this.buildPartial();
        ...
        public JwtRsaSsaPssKeyFormat buildPartial() {
            JwtRsaSsaPssKeyFormat result2 = new JwtRsaSsaPssKeyFormat(this);
        ...
        private void buildPartial0(JwtRsaSsaPssKeyFormat result2) {
