...
implements HmacParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacParams.class.getName());
    ...
    implements HmacParamsOrBuilder {
        ...
        public HmacParams build() {
            HmacParams result2 = this.buildPartial();
        ...
        public HmacParams buildPartial() {
            HmacParams result2 = new HmacParams(this);
        ...
        private void buildPartial0(HmacParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.hash_ = this.hash_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.tagSize_ = this.tagSize_;
            }
        }
