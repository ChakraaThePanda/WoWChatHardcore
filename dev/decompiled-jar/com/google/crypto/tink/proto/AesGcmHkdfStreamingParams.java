...
implements AesGcmHkdfStreamingParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesGcmHkdfStreamingParams.class.getName());
    ...
    implements AesGcmHkdfStreamingParamsOrBuilder {
        ...
        public AesGcmHkdfStreamingParams build() {
            AesGcmHkdfStreamingParams result2 = this.buildPartial();
        ...
        public AesGcmHkdfStreamingParams buildPartial() {
            AesGcmHkdfStreamingParams result2 = new AesGcmHkdfStreamingParams(this);
        ...
        private void buildPartial0(AesGcmHkdfStreamingParams result2) {
