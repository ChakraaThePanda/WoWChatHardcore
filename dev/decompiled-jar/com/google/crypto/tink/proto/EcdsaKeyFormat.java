...
implements EcdsaKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EcdsaKeyFormat.class.getName());
    ...
    implements EcdsaKeyFormatOrBuilder {
        ...
        public EcdsaKeyFormat build() {
            EcdsaKeyFormat result2 = this.buildPartial();
        ...
        public EcdsaKeyFormat buildPartial() {
            EcdsaKeyFormat result2 = new EcdsaKeyFormat(this);
        ...
        private void buildPartial0(EcdsaKeyFormat result2) {
