...
implements RsaSsaPkcs1PrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPkcs1PrivateKey.class.getName());
    ...
    implements RsaSsaPkcs1PrivateKeyOrBuilder {
        ...
        public RsaSsaPkcs1PrivateKey build() {
            RsaSsaPkcs1PrivateKey result2 = this.buildPartial();
        ...
        public RsaSsaPkcs1PrivateKey buildPartial() {
            RsaSsaPkcs1PrivateKey result2 = new RsaSsaPkcs1PrivateKey(this);
        ...
        private void buildPartial0(RsaSsaPkcs1PrivateKey result2) {
        ...
        private SingleFieldBuilder<RsaSsaPkcs1PublicKey, RsaSsaPkcs1PublicKey.Builder, RsaSsaPkcs1PublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
