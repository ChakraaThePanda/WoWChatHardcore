...
implements KeysetInfoOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KeysetInfo.class.getName());
    ...
    implements KeysetInfoOrBuilder {
        ...
        public KeysetInfo build() {
            KeysetInfo result2 = this.buildPartial();
        ...
        public KeysetInfo buildPartial() {
            KeysetInfo result2 = new KeysetInfo(this);
        ...
        private void buildPartialRepeatedFields(KeysetInfo result2) {
            if (this.keyInfoBuilder_ == null) {
                if ((this.bitField0_ & 2) != 0) {
                    this.keyInfo_ = Collections.unmodifiableList(this.keyInfo_);
                    this.bitField0_ &= 0xFFFFFFFD;
                }
                result2.keyInfo_ = this.keyInfo_;
            } else {
                result2.keyInfo_ = this.keyInfoBuilder_.build();
            }
        }

        private void buildPartial0(KeysetInfo result2) {
        ...
        public Builder mergeFrom(KeysetInfo other) {
            ...
            if (this.keyInfoBuilder_ == null) {
                ...
                if (this.keyInfoBuilder_.isEmpty()) {
                    ...
                    this.keyInfo_ = other.keyInfo_;
                    this.bitField0_ &= 0xFFFFFFFD;
                    this.keyInfoBuilder_ = alwaysUseFieldBuilders ? this.getKeyInfoFieldBuilder() : null;
                } else {
        ...
        public Builder addAllKeyInfo(Iterable<? extends KeyInfo> values2) {
            if (this.keyInfoBuilder_ == null) {
                this.ensureKeyInfoIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.keyInfo_);
                this.onChanged();
            } else {
                this.keyInfoBuilder_.addAllMessages(values2);
            }
            return this;
        }
        ...
        public KeyInfo.Builder getKeyInfoBuilder(int index) {
            return this.getKeyInfoFieldBuilder().getBuilder(index);
        }
        ...
        public KeyInfo.Builder addKeyInfoBuilder() {
            return this.getKeyInfoFieldBuilder().addBuilder(KeyInfo.getDefaultInstance());
        }

        public KeyInfo.Builder addKeyInfoBuilder(int index) {
            return this.getKeyInfoFieldBuilder().addBuilder(index, KeyInfo.getDefaultInstance());
        }
    ...
    implements KeyInfoOrBuilder {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KeyInfo.class.getName());
        ...
        implements KeyInfoOrBuilder {
            ...
            public KeyInfo build() {
                KeyInfo result2 = this.buildPartial();
                if (!result2.isInitialized()) {
                    throw Builder.newUninitializedMessageException(result2);
                }
                return result2;
            ...
            public KeyInfo buildPartial() {
                KeyInfo result2 = new KeyInfo(this);
                if (this.bitField0_ != 0) {
                    this.buildPartial0(result2);
                }
                this.onBuilt();
            ...
            private void buildPartial0(KeyInfo result2) {
                int from_bitField0_ = this.bitField0_;
                if ((from_bitField0_ & 1) != 0) {
