...
implements AesCmacKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCmacKeyFormat.class.getName());
    ...
    implements AesCmacKeyFormatOrBuilder {
        ...
        public AesCmacKeyFormat build() {
            AesCmacKeyFormat result2 = this.buildPartial();
        ...
        public AesCmacKeyFormat buildPartial() {
            AesCmacKeyFormat result2 = new AesCmacKeyFormat(this);
        ...
        private void buildPartial0(AesCmacKeyFormat result2) {
        ...
        private SingleFieldBuilder<AesCmacParams, AesCmacParams.Builder, AesCmacParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
