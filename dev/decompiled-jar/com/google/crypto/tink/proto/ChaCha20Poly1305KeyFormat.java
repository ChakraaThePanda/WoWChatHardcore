...
implements ChaCha20Poly1305KeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", ChaCha20Poly1305KeyFormat.class.getName());
    ...
    implements ChaCha20Poly1305KeyFormatOrBuilder {
        ...
        public ChaCha20Poly1305KeyFormat build() {
            ChaCha20Poly1305KeyFormat result2 = this.buildPartial();
        ...
        public ChaCha20Poly1305KeyFormat buildPartial() {
            ChaCha20Poly1305KeyFormat result2 = new ChaCha20Poly1305KeyFormat(this);
            this.onBuilt();
            return result2;
        }
