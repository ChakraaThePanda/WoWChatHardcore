...
implements HkdfPrfParamsOrBuilder {
    ...
    public HashType getHash() {
        HashType result2 = HashType.forNumber(this.hash_);
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HkdfPrfParams.class.getName());
    ...
    implements HkdfPrfParamsOrBuilder {
        ...
        public HkdfPrfParams build() {
            HkdfPrfParams result2 = this.buildPartial();
        ...
        public HkdfPrfParams buildPartial() {
            HkdfPrfParams result2 = new HkdfPrfParams(this);
        ...
        private void buildPartial0(HkdfPrfParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.hash_ = this.hash_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.salt_ = this.salt_;
            }
        }
