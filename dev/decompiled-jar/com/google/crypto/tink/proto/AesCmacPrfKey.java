...
implements AesCmacPrfKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCmacPrfKey.class.getName());
    ...
    implements AesCmacPrfKeyOrBuilder {
        ...
        public AesCmacPrfKey build() {
            AesCmacPrfKey result2 = this.buildPartial();
        ...
        public AesCmacPrfKey buildPartial() {
            AesCmacPrfKey result2 = new AesCmacPrfKey(this);
        ...
        private void buildPartial0(AesCmacPrfKey result2) {
