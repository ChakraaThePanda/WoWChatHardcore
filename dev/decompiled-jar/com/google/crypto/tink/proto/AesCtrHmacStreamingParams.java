...
implements AesCtrHmacStreamingParamsOrBuilder {
    ...
    public HashType getHkdfHashType() {
        HashType result2 = HashType.forNumber(this.hkdfHashType_);
        return result2 == null ? HashType.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCtrHmacStreamingParams.class.getName());
    ...
    implements AesCtrHmacStreamingParamsOrBuilder {
        ...
        public AesCtrHmacStreamingParams build() {
            AesCtrHmacStreamingParams result2 = this.buildPartial();
        ...
        public AesCtrHmacStreamingParams buildPartial() {
            AesCtrHmacStreamingParams result2 = new AesCtrHmacStreamingParams(this);
        ...
        private void buildPartial0(AesCtrHmacStreamingParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.ciphertextSegmentSize_ = this.ciphertextSegmentSize_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.derivedKeySize_ = this.derivedKeySize_;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.hkdfHashType_ = this.hkdfHashType_;
            }
            int to_bitField0_ = 0;
            if ((from_bitField0_ & 8) != 0) {
                result2.hmacParams_ = this.hmacParamsBuilder_ == null ? this.hmacParams_ : this.hmacParamsBuilder_.build();
                to_bitField0_ |= 1;
            }
        ...
        public HmacParams.Builder getHmacParamsBuilder() {
            this.bitField0_ |= 8;
            this.onChanged();
            return this.getHmacParamsFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<HmacParams, HmacParams.Builder, HmacParamsOrBuilder> getHmacParamsFieldBuilder() {
            if (this.hmacParamsBuilder_ == null) {
