...
implements ChaCha20Poly1305KeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", ChaCha20Poly1305Key.class.getName());
    ...
    implements ChaCha20Poly1305KeyOrBuilder {
        ...
        public ChaCha20Poly1305Key build() {
            ChaCha20Poly1305Key result2 = this.buildPartial();
        ...
        public ChaCha20Poly1305Key buildPartial() {
            ChaCha20Poly1305Key result2 = new ChaCha20Poly1305Key(this);
        ...
        private void buildPartial0(ChaCha20Poly1305Key result2) {
