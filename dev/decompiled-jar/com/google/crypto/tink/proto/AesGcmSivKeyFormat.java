...
implements AesGcmSivKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesGcmSivKeyFormat.class.getName());
    ...
    implements AesGcmSivKeyFormatOrBuilder {
        ...
        public AesGcmSivKeyFormat build() {
            AesGcmSivKeyFormat result2 = this.buildPartial();
        ...
        public AesGcmSivKeyFormat buildPartial() {
            AesGcmSivKeyFormat result2 = new AesGcmSivKeyFormat(this);
        ...
        private void buildPartial0(AesGcmSivKeyFormat result2) {
