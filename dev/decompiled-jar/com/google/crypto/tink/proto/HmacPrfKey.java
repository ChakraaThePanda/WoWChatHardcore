...
implements HmacPrfKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacPrfKey.class.getName());
    ...
    implements HmacPrfKeyOrBuilder {
        ...
        public HmacPrfKey build() {
            HmacPrfKey result2 = this.buildPartial();
        ...
        public HmacPrfKey buildPartial() {
            HmacPrfKey result2 = new HmacPrfKey(this);
        ...
        private void buildPartial0(HmacPrfKey result2) {
