...
public final class AesSivProtoSerialization {
    ...
    private static Map<AesSivParameters.Variant, OutputPrefixType> createVariantToOutputPrefixMap() {
        HashMap<AesSivParameters.Variant, OutputPrefixType> result2 = new HashMap<AesSivParameters.Variant, OutputPrefixType>();
        result2.put(AesSivParameters.Variant.NO_PREFIX, OutputPrefixType.RAW);
        result2.put(AesSivParameters.Variant.TINK, OutputPrefixType.TINK);
        result2.put(AesSivParameters.Variant.CRUNCHY, OutputPrefixType.CRUNCHY);
    ...
    private static Map<OutputPrefixType, AesSivParameters.Variant> createOutputPrefixToVariantMap() {
        EnumMap<OutputPrefixType, AesSivParameters.Variant> result2 = new EnumMap<OutputPrefixType, AesSivParameters.Variant>(OutputPrefixType.class);
        result2.put(OutputPrefixType.RAW, AesSivParameters.Variant.NO_PREFIX);
        result2.put(OutputPrefixType.TINK, AesSivParameters.Variant.TINK);
        result2.put(OutputPrefixType.CRUNCHY, AesSivParameters.Variant.CRUNCHY);
        result2.put(OutputPrefixType.LEGACY, AesSivParameters.Variant.CRUNCHY);
        return Collections.unmodifiableMap(result2);
    }
