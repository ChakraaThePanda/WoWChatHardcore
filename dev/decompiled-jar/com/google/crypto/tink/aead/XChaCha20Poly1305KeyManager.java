...
public final class XChaCha20Poly1305KeyManager {
    ...
    private static final MutableKeyCreationRegistry.KeyCreator<XChaCha20Poly1305Parameters> KEY_CREATOR = XChaCha20Poly1305KeyManager::createXChaChaKey;
    ...
    private static Map<String, Parameters> namedParameters() throws GeneralSecurityException {
        HashMap<String, XChaCha20Poly1305Parameters> result2 = new HashMap<String, XChaCha20Poly1305Parameters>();
        result2.put("XCHACHA20_POLY1305", XChaCha20Poly1305Parameters.create(XChaCha20Poly1305Parameters.Variant.TINK));
        result2.put("XCHACHA20_POLY1305_RAW", XChaCha20Poly1305Parameters.create(XChaCha20Poly1305Parameters.Variant.NO_PREFIX));
