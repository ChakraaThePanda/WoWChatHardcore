...
public class HkdfPrfKeyManager {
    ...
    static final MutableKeyCreationRegistry.KeyCreator<HkdfPrfParameters> KEY_CREATOR = HkdfPrfKeyManager::newKey;
    ...
    private static Map<String, Parameters> namedParameters() throws GeneralSecurityException {
        HashMap<String, HkdfPrfParameters> result2 = new HashMap<String, HkdfPrfParameters>();
        result2.put("HKDF_SHA256", PredefinedPrfParameters.HKDF_SHA256);
