        ...
        final void bufferUInt32NoTag(int value) {
            if (HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while (true) {
                    ...
                    UnsafeUtil.putByte(this.buffer, (long)this.position++, (byte)((value | 0x80) & 0xFF));
                    value >>>= 7;
                }
                ...
                while (true) {
                    ...
                    this.buffer[this.position++] = (byte)((value | 0x80) & 0xFF);
                    ++this.totalBytesWritten;
                    value >>>= 7;
                }
            }
        ...
        final void bufferUInt64NoTag(long value) {
            if (HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while (true) {
                    ...
                    UnsafeUtil.putByte(this.buffer, (long)this.position++, (byte)(((int)value | 0x80) & 0xFF));
                    value >>>= 7;
                }
                UnsafeUtil.putByte(this.buffer, (long)this.position++, (byte)value);
                int delta = (int)((long)this.position - originalPos);
                ...
                while (true) {
                    ...
                    this.buffer[this.position++] = (byte)(((int)value | 0x80) & 0xFF);
                    ++this.totalBytesWritten;
                    value >>>= 7;
                }
            }
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while (true) {
                    ...
                    UnsafeUtil.putByte(this.position++, (byte)((value | 0x80) & 0xFF));
                    value >>>= 7;
                }
            }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while (true) {
                    ...
                    UnsafeUtil.putByte(this.position++, (byte)(((int)value | 0x80) & 0xFF));
                    value >>>= 7;
                }
            }
            while (this.position < this.limit) {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            try {
                while (true) {
                    ...
                    this.buffer.put((byte)((value | 0x80) & 0xFF));
                    value >>>= 7;
                }
            }
            catch (BufferOverflowException e) {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            try {
                while (true) {
                    ...
                    this.buffer.put((byte)(((int)value | 0x80) & 0xFF));
                    value >>>= 7;
                }
            }
            catch (BufferOverflowException e) {
