...
public enum FieldType {
    ...
    public boolean isValidForField(Field field2) {
        if (Collection.VECTOR.equals((Object)this.collection)) {
            return this.isValidForList(field2);
        }
        return this.javaType.getType().isAssignableFrom(field2.getType());
    }

    private boolean isValidForList(Field field2) {
        Type listParameter;
        ...
        if (genericType instanceof ParameterizedType) {
            types = ((ParameterizedType)field2.getGenericType()).getActualTypeArguments();
        }
