...
implements UInt64ValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", UInt64Value.class.getName());
    ...
    implements UInt64ValueOrBuilder {
        ...
        private void buildPartial0(UInt64Value result2) {
