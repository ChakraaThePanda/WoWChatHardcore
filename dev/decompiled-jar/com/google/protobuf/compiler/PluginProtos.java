...
public final class PluginProtos {
    ...
    implements CodeGeneratorResponseOrBuilder {
        ...
        implements CodeGeneratorResponseOrBuilder {
            ...
            private void buildPartialRepeatedFields(CodeGeneratorResponse result2) {
                if (this.fileBuilder_ == null) {
            ...
            private void buildPartial0(CodeGeneratorResponse result2) {
                ...
                if ((from_bitField0_ & 2) != 0) {
                    result2.supportedFeatures_ = this.supportedFeatures_;
                    to_bitField0_ |= 2;
                }
                if ((from_bitField0_ & 4) != 0) {
                    result2.minimumEdition_ = this.minimumEdition_;
                    to_bitField0_ |= 4;
                }
                if ((from_bitField0_ & 8) != 0) {
                    result2.maximumEdition_ = this.maximumEdition_;
                    to_bitField0_ |= 8;
                }
        ...
        implements FileOrBuilder {
            ...
            implements FileOrBuilder {
                ...
                private void buildPartial0(File result2) {
                    int from_bitField0_ = this.bitField0_;
                    int to_bitField0_ = 0;
                    if ((from_bitField0_ & 1) != 0) {
                    ...
                    if ((from_bitField0_ & 8) != 0) {
                        result2.generatedCodeInfo_ = this.generatedCodeInfoBuilder_ == null ? this.generatedCodeInfo_ : this.generatedCodeInfoBuilder_.build();
                        to_bitField0_ |= 8;
                    }
                    result2.bitField0_ |= to_bitField0_;
                }
    ...
    implements CodeGeneratorRequestOrBuilder {
        ...
        implements CodeGeneratorRequestOrBuilder {
            ...
            private void buildPartialRepeatedFields(CodeGeneratorRequest result2) {
                if (this.protoFileBuilder_ == null) {
                    if ((this.bitField0_ & 4) != 0) {
                ...
                if (this.sourceFileDescriptorsBuilder_ == null) {
                    ...
                    result2.sourceFileDescriptors_ = this.sourceFileDescriptors_;
                } else {
                    result2.sourceFileDescriptors_ = this.sourceFileDescriptorsBuilder_.build();
                }
            }

            private void buildPartial0(CodeGeneratorRequest result2) {
                int from_bitField0_ = this.bitField0_;
                if ((from_bitField0_ & 1) != 0) {
                ...
                if ((from_bitField0_ & 0x10) != 0) {
                    result2.compilerVersion_ = this.compilerVersionBuilder_ == null ? this.compilerVersion_ : this.compilerVersionBuilder_.build();
                    to_bitField0_ |= 2;
                }
                result2.bitField0_ |= to_bitField0_;
            }
    ...
    implements VersionOrBuilder {
        ...
        implements VersionOrBuilder {
            ...
            private void buildPartial0(Version result2) {
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 1) != 0) {
