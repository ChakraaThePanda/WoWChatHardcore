...
implements FieldOrBuilder {
    ...
    @Override
    public Kind getKind() {
        Kind result2 = Kind.forNumber(this.kind_);
    ...
    public Cardinality getCardinality() {
        Cardinality result2 = Cardinality.forNumber(this.cardinality_);
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Field.class.getName());
    ...
    implements FieldOrBuilder {
        ...
        private void buildPartialRepeatedFields(Field result2) {
            if (this.optionsBuilder_ == null) {
        ...
        private void buildPartial0(Field result2) {
    ...
    public static enum Cardinality implements ProtocolMessageEnum
    {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Cardinality.class.getName());
    ...
    public static enum Kind implements ProtocolMessageEnum
    {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Kind.class.getName());
