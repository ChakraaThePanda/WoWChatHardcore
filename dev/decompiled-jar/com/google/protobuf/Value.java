...
implements ValueOrBuilder {
    ...
    public NullValue getNullValue() {
        if (this.kindCase_ == 1) {
            NullValue result2 = NullValue.forNumber((Integer)this.kind_);
    ...
    implements ValueOrBuilder {
        ...
        public Value buildPartial() {
            ...
            this.buildPartialOneofs(result2);
            this.onBuilt();
            return result2;
        }

        private void buildPartial0(Value result2) {
            int from_bitField0_ = this.bitField0_;
        }

        private void buildPartialOneofs(Value result2) {
            ...
            try {
                ...
                block14: while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 42: {
                            input.readMessage(this.getStructValueFieldBuilder().getBuilder(), extensionRegistry);
                            this.kindCase_ = 5;
                            continue block14;
                        }
                        case 50: {
                            input.readMessage(this.getListValueFieldBuilder().getBuilder(), extensionRegistry);
                            this.kindCase_ = 6;
                            continue block14;
                        }
                    }
