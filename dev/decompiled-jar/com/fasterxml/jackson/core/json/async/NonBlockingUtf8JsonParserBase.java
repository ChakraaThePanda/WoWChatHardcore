...
extends NonBlockingJsonParserBase {
    ...
    protected JsonToken _finishKeywordToken(String expToken, int matched, JsonToken result2) throws IOException {
        ...
        while (true) {
            ...
            if (matched == end) {
                ...
                return this._valueComplete(result2);
            }
    ...
    protected JsonToken _finishKeywordTokenWithEOF(String expToken, int matched, JsonToken result2) throws IOException {
        if (matched == expToken.length()) {
            return this._updateToken(result2);
        }
        this._textBuffer.resetWithCopy(expToken, 0, matched);
        return this._finishErrorTokenWithEOF();
    }
    ...
    private final JsonToken _finishRegularString() throws IOException {
        ...
        block6: while (true) {
            ...
            int max = Math.min(this._inputEnd, InternalJacksonUtil.addOverflowSafe(ptr, outBuf.length - outPtr));
            while (true) {
