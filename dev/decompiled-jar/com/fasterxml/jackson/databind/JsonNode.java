...
Iterable<JsonNode> {
    ...
    public final List<JsonNode> findValues(String fieldName) {
        List<JsonNode> result2 = this.findValues(fieldName, null);
        if (result2 == null) {
    ...
    public final List<String> findValuesAsText(String fieldName) {
        List<String> result2 = this.findValuesAsText(fieldName, null);
        if (result2 == null) {
            return Collections.emptyList();
        }
        return result2;
    ...
    public final List<JsonNode> findParents(String fieldName) {
        List<JsonNode> result2 = this.findParents(fieldName, null);
        if (result2 == null) {
            return Collections.emptyList();
        }
        return result2;
