...
public final class ClassUtil {
    ...
    public static List<JavaType> findSuperTypes(JavaType type, Class<?> endBefore, boolean addClassItself) {
        ...
        ClassUtil._addSuperTypes(type, endBefore, result2, addClassItself);
        return result2;
    }
    ...
    private static void _addSuperTypes(JavaType type, Class<?> endBefore, Collection<JavaType> result2, boolean addClassItself) {
        if (type == null) {
            return;
        }
        ...
        ClassUtil._addSuperTypes(type.getSuperClass(), endBefore, result2, true);
    }
    ...
    public static <T extends Annotation> Enum<?> findFirstAnnotatedEnumValue(Class<Enum<?>> enumClass, Class<T> annotationClass) {
        Field[] fields;
        for (Field field2 : fields = enumClass.getDeclaredFields()) {
            T defaultValueAnnotation;
            if (!field2.isEnumConstant() || (defaultValueAnnotation = field2.getAnnotation(annotationClass)) == null) continue;
    ...
    private static class EnumTypeLocator {
        ...
        private Object get(Object bean, Field field2) {
            try {
                return field2.get(bean);
            }
            catch (Exception e) {
