...
extends Socket {
    ...
    void joinGroup(InetAddress group, NetworkInterface netInterface, InetAddress source2) throws IOException {
        ...
        if (source2 != null) {
            if (source2.getClass() != group.getClass()) {
                throw new IllegalArgumentException("Source address is different type to group");
            }
            NativeInetAddress s = NativeInetAddress.newInstance(source2);
    ...
    void leaveGroup(InetAddress group, NetworkInterface netInterface, InetAddress source2) throws IOException {
        NativeInetAddress g = NativeInetAddress.newInstance(group);
        boolean isIpv6 = group instanceof Inet6Address;
        NativeInetAddress i = NativeInetAddress.newInstance(LinuxSocket.deriveInetAddress(netInterface, isIpv6));
        if (source2 != null) {
