...
extends MultithreadEventExecutorGroup {
    ...
    @Override
    protected EventExecutor newChild(Executor executor, Object ... args2) throws Exception {
        return new DefaultEventExecutor((EventExecutorGroup)this, executor, (int)((Integer)args2[0]), (RejectedExecutionHandler)args2[1]);
    }
}
