...
PriorityQueueNode {
    ...
    ScheduledFutureTask(AbstractScheduledEventExecutor executor, Runnable runnable2, long nanoTime) {
        super((EventExecutor)executor, runnable2);
        this.deadlineNanos = nanoTime;
        this.periodNanos = 0L;
    }

    ScheduledFutureTask(AbstractScheduledEventExecutor executor, Runnable runnable2, long nanoTime, long period) {
        super((EventExecutor)executor, runnable2);
        this.deadlineNanos = nanoTime;
