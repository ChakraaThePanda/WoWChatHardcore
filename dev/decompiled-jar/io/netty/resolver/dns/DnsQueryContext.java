...
implements FutureListener<AddressedEnvelope<DnsResponse, InetSocketAddress>> {
    ...
    private void sendQuery(final DnsQuery query, boolean flush, final ChannelPromise writePromise) {
        if (this.parent.channelReadyPromise.isSuccess()) {
            ...
            if (cause != null) {
                ...
                this.parent.channelReadyPromise.addListener((GenericFutureListener<Future<Channel>>)new GenericFutureListener<Future<? super Channel>>(){
    ...
    boolean tryFailure(String message, Throwable cause, boolean timeout2) {
        ...
        DnsNameResolverException e = timeout2 ? new DnsNameResolverTimeoutException(nameServerAddr, this.question(), buf.toString()) : new DnsNameResolverException(nameServerAddr, this.question(), buf.toString(), cause);
