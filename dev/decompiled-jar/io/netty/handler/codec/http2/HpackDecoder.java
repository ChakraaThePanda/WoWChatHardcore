...
final class HpackDecoder {
    ...
    void decode(int streamId, ByteBuf in, Http2Headers headers, boolean validateHeaders) throws Http2Exception {
        Http2HeadersSink sink2 = new Http2HeadersSink(streamId, headers, this.maxHeaderListSize, validateHeaders);
        this.decodeDynamicTableSizeUpdates(in);
        this.decode(in, sink2);
        sink2.finish();
    }
    ...
    private void decode(ByteBuf in, Http2HeadersSink sink2) throws Http2Exception {
        int index = 0;
        int nameLength = 0;
        int valueLength = 0;
        int state = 0;
            ...
            switch (state) {
                case 0: {
                    ...
                    if (b < 0) {
                        ...
                        sink2.appendToHeaderList((AsciiString)indexedHeader.name, (AsciiString)indexedHeader.value);
                        continue block27;
                    }
                    if ((b & 0x40) == 64) {
                ...
                case 6: {
                    ...
                    switch (index) {
                        ...
                        case 0: {
                            this.insertHeader(sink2, name, AsciiString.EMPTY_STRING, indexType);
                            state = 0;
                            continue block27;
                        }
                    }
                ...
                case 8: {
                    ...
                    this.insertHeader(sink2, name, value, indexType);
                    state = 0;
                    continue block27;
                }
            }
    ...
    private void insertHeader(Http2HeadersSink sink2, AsciiString name, AsciiString value, HpackUtil.IndexType indexType) {
        sink2.appendToHeaderList(name, value);
        switch (indexType) {
            case NONE: 
            case NEVER: {
                break;
