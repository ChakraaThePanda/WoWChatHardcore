...
public final class MqttSubscriptionOption {
    ...
    public int hashCode() {
        int result2 = this.qos.hashCode();
        result2 = 31 * result2 + (this.noLocal ? 1 : 0);
        result2 = 31 * result2 + (this.retainAsPublished ? 1 : 0);
        result2 = 31 * result2 + this.retainHandling.hashCode();
        return result2;
    }
