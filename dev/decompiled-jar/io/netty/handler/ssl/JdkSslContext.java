...
extends SslContext {
    ...
    private SSLEngine configureAndWrapEngine(SSLEngine engine, ByteBufAllocator alloc) {
        JdkApplicationProtocolNegotiator.SslEngineWrapperFactory factory2;
        ...
        if ((factory2 = this.apn.wrapperFactory()) instanceof JdkApplicationProtocolNegotiator.AllocatorAwareSslEngineWrapperFactory) {
            return ((JdkApplicationProtocolNegotiator.AllocatorAwareSslEngineWrapperFactory)factory2).wrapSslEngine(engine, alloc, this.apn, this.isServer());
        }
        return factory2.wrapSslEngine(engine, this.apn, this.isServer());
    }
