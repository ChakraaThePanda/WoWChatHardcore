...
public final class Http2 {
    ...
    public final String formatFlags(int type, int flags) {
        ...
        return type == 5 && (flags & 4) != 0 ? StringsKt.replace$default(result2, "HEADERS", "PUSH_PROMISE", false, 4, null) : (type == 0 && (flags & 0x20) != 0 ? StringsKt.replace$default(result2, "PRIORITY", "COMPRESSED", false, 4, null) : result2);
    }
