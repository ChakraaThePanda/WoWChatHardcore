...
public final class -SegmentedByteString {
    ...
    public static final String toHexString(byte $this$toHexString) {
        ...
        int other$iv = 4;
        boolean $i$f$shr = false;
        result2[0] = -ByteString.getHEX_DIGIT_CHARS()[$this$shr$iv >> other$iv & 0xF];
        $this$shr$iv = $this$toHexString;
        other$iv = 15;
        boolean $i$f$and = false;
        result2[1] = -ByteString.getHEX_DIGIT_CHARS()[$this$and$iv & other$iv];
    ...
    public static final String toHexString(int $this$toHexString) {
        ...
        char[] result2 = new char[]{-ByteString.getHEX_DIGIT_CHARS()[$this$toHexString >> 28 & 0xF], -ByteString.getHEX_DIGIT_CHARS()[$this$toHexString >> 24 & 0xF], -ByteString.getHEX_DIGIT_CHARS()[$this$toHexString >> 20 & 0xF], -ByteString.getHEX_DIGIT_CHARS()[$this$toHexString >> 16 & 0xF], -ByteString.getHEX_DIGIT_CHARS()[$this$toHexString >> 12 & 0xF], -ByteString.getHEX_DIGIT_CHARS()[$this$toHexString >> 8 & 0xF], -ByteString.getHEX_DIGIT_CHARS()[$this$toHexString >> 4 & 0xF], -ByteString.getHEX_DIGIT_CHARS()[$this$toHexString & 0xF]};
        for (i = 0; i < result2.length && result2[i] == '0'; ++i) {
        }
        return StringsKt.concatToString(result2, i, result2.length);
    }
