...
public class EmbedBuilder {
    ...
    public static EmbedBuilder fromData(@Nonnull DataObject data) {
        ...
        data.optArray("fields").ifPresent(arr -> arr.stream(DataArray::getObject).forEach(field2 -> builder.addField(field2.getString("name", ZERO_WIDTH_SPACE), field2.getString("value", ZERO_WIDTH_SPACE), field2.getBoolean("inline", false))));
        return builder;
    }
    ...
    public boolean isEmpty() {
        return (this.title == null || this.title.trim().isEmpty()) && this.thumbnail == null && this.author == null && this.footer == null && this.image == null && this.description.toString().trim().isEmpty() && this.fields.isEmpty();
    }
    ...
    @Nonnull
    public EmbedBuilder addField(@Nullable MessageEmbed.Field field2) {
        return field2 == null ? this : this.addField(field2.getName(), field2.getValue(), field2.isInline());
    }

    @Nonnull
    public EmbedBuilder addField(@Nonnull String name, @Nonnull String value, boolean inline2) {
        Checks.notNull(name, "Name");
        Checks.notNull(value, "Value");
        this.fields.add(new MessageEmbed.Field(name, value, inline2));
        return this;
    }

    @Nonnull
    public EmbedBuilder addBlankField(boolean inline2) {
        this.fields.add(new MessageEmbed.Field(ZERO_WIDTH_SPACE, ZERO_WIDTH_SPACE, inline2));
        return this;
    }
