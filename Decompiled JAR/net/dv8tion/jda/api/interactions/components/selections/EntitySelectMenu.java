...
extends SelectMenu {
    ...
    extends SelectMenu.Builder<EntitySelectMenu, Builder> {
        ...
        @Nonnull
        public Builder setDefaultValues(DefaultValue ... values2) {
            Checks.noneNull(values2, "Default Values");
            return this.setDefaultValues(Arrays.asList(values2));
        }

        @Nonnull
        public Builder setDefaultValues(@Nonnull Collection<? extends DefaultValue> values2) {
            Checks.noneNull(values2, "Default Values");
            Checks.check(values2.size() <= 25, "Cannot add more than %d default values to a select menu!", (Object)25);
            for (DefaultValue defaultValue : values2) {
            ...
            this.defaultValues.addAll(values2);
            return this;
        }
