...
extends GenericChannelUpdateEvent<List<Long>> {
    ...
    public ChannelUpdateAppliedTagsEvent(@Nonnull JDA api2, long responseNumber, @Nonnull ThreadChannel channel, @Nonnull List<Long> oldValue, @Nonnull List<Long> newValue) {
