...
extends GenericPermissionOverrideEvent {
    ...
    public PermissionOverrideUpdateEvent(@Nonnull JDA api2, long responseNumber, @Nonnull IPermissionContainer channel, @Nonnull PermissionOverride override, long oldAllow, long oldDeny) {
