...
extends GenericScheduledEventUpdateEvent<String> {
    ...
    public ScheduledEventUpdateLocationEvent(@Nonnull JDA api2, long responseNumber, @Nonnull ScheduledEvent scheduledEvent, @Nonnull String previous) {
        super(api2, responseNumber, scheduledEvent, previous, scheduledEvent.getLocation(), IDENTIFIER);
    }
