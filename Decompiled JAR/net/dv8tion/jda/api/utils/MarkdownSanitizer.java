    ...
    public String compute(@Nonnull String sequence2) {
        ...
        while (i < sequence2.length()) {
            ...
            if (nextRegion == 0) {
                ...
                if (!isNewLine && (!isSpace || !onlySpacesSinceNewLine) || i >= sequence2.length() || (result2 = this.handleQuote(sequence2.substring(i))) == null) continue;
                return builder.append(result2).toString();
            }
