...
public class Route {
    ...
    public static class Guilds {
        ...
        public static final Route GET_VOICE_STATE = new Route(Method.GET, "guilds/{guild_id}/voice-states/{user_id}");
        ...
        public static final Route MODIFY_GUILD_INCIDENTS = new Route(Method.PUT, "guilds/{guild_id}/incident-actions");
    ...
    public static class Applications {
        ...
        public static final Route EDIT_BOT_APPLICATION = new Route(Method.PATCH, "applications/@me");
