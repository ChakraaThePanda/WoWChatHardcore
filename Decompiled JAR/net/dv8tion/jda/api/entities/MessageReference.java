...
public class MessageReference {
    ...
    public MessageReference(int type, long messageId, long channelId, long guildId, @Nullable Message referencedMessage, JDA api2) {
        this.type = type;
        this.messageId = messageId;
        this.channelId = channelId;
        this.guildId = guildId;
        this.referencedMessage = referencedMessage;
        this.channel = guildId == 0L ? api2.getPrivateChannelById(channelId) : api2.getChannelById(MessageChannel.class, channelId);
        this.guild = api2.getGuildById(guildId);
        this.api = api2;
    }
