...
public final class -ByteString {
    ...
    public static final String commonUtf8(@NotNull ByteString $this$commonUtf8) {
        ...
        String result2 = $this$commonUtf8.getUtf8$okio();
        if (result2 == null) {
            result2 = _JvmPlatformKt.toUtf8String($this$commonUtf8.internalArray$okio());
    ...
    public static final String commonHex(@NotNull ByteString $this$commonHex) {
        ...
        char[] result2 = new char[$this$commonHex.getData$okio().length * 2];
        int c = 0;
        for (byte b : $this$commonHex.getData$okio()) {
            ...
            result2[n] = -ByteString.getHEX_DIGIT_CHARS()[$this$shr$iv >> other$iv & 0xF];
            int n2 = c++;
            $this$shr$iv = b;
            other$iv = 15;
            boolean $i$f$and = false;
            result2[n2] = -ByteString.getHEX_DIGIT_CHARS()[$this$and$iv & other$iv];
        }
    ...
    public static final int commonHashCode(@NotNull ByteString $this$commonHashCode) {
        ...
        int result2 = $this$commonHashCode.getHashCode$okio();
        if (result2 != 0) {
            return result2;
        }
    ...
    public static final ByteString commonDecodeHex(@NotNull String $this$commonDecodeHex) {
        ...
        byte[] result2 = new byte[$this$commonDecodeHex.length() / 2];
        ...
        for (int i = 0; i < n; ++i) {
            ...
            result2[i] = (byte)(d1 + d2);
        }
        return new ByteString(result2);
    }
