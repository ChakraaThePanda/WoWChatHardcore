...
extends JsonGeneratorImpl {
    ...
    private final void _writeStringSegment2(char[] cbuf, int offset, int end) throws IOException {
        ...
        while (offset < end) {
            ...
            if (UTF8JsonGenerator._isStartOfSurrogatePair(ch) && (combineSurrogates = JsonGenerator.Feature.COMBINE_UNICODE_SURROGATES_IN_UTF8.enabledIn(this._features)) && offset < end) {
