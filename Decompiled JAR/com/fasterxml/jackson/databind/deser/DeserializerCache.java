...
implements Serializable {
    ...
    protected JsonDeserializer<Object> _createAndCacheValueDeserializer(DeserializationContext ctxt, DeserializerFactory factory2, JavaType type) throws JsonMappingException {
        ...
        try {
            JsonDeserializer<Object> deser2;
            if (!isCustom && (deser = this._cachedDeserializers.get(type)) != null) {
            ...
            if (count > 0 && (deser2 = this._incompleteDeserializers.get(type)) != null) {
                JsonDeserializer<Object> jsonDeserializer = deser2;
                return jsonDeserializer;
            }
            try {
                JsonDeserializer<Object> jsonDeserializer = this._createAndCache2(ctxt, factory2, type, isCustom);
    ...
    protected JsonDeserializer<Object> _createAndCache2(DeserializationContext ctxt, DeserializerFactory factory2, JavaType type) throws JsonMappingException {
        return this._createAndCache2(ctxt, factory2, type, this._hasCustomHandlers(type));
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    protected JsonDeserializer<Object> _createAndCache2(DeserializationContext ctxt, DeserializerFactory factory2, JavaType type, boolean isCustom) throws JsonMappingException {
        boolean addToCache;
        JsonDeserializer<Object> deser;
        try {
        ...
        boolean bl = addToCache = !isCustom && deser.isCachable();
