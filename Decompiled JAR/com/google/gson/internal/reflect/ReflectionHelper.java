...
public class ReflectionHelper {
    ...
    public static String fieldToString(Field field2) {
        return field2.getDeclaringClass().getName() + "#" + field2.getName();
    }
    ...
    public static Method getAccessor(Class<?> raw, Field field2) {
        return RECORD_HELPER.getAccessor(raw, field2);
    }
    ...
    extends RecordHelper {
        ...
        @Override
        public Method getAccessor(Class<?> raw, Field field2) {
            throw new UnsupportedOperationException("Records are not supported on this JVM, this method should not be called");
        }
    }
    ...
    extends RecordHelper {
        ...
        public Method getAccessor(Class<?> raw, Field field2) {
            try {
                return raw.getMethod(field2.getName(), new Class[0]);
            }
            catch (ReflectiveOperationException e) {
                throw ReflectionHelper.createExceptionForRecordReflectionException(e);
            }
