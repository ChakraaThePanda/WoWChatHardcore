...
implements TypeOrBuilder {
    ...
    public Syntax getSyntax() {
        Syntax result2 = Syntax.forNumber(this.syntax_);
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Type.class.getName());
    ...
    implements TypeOrBuilder {
        ...
        private void buildPartialRepeatedFields(Type result2) {
            if (this.fieldsBuilder_ == null) {
        ...
        private void buildPartial0(Type result2) {
            ...
            if ((from_bitField0_ & 0x10) != 0) {
                result2.sourceContext_ = this.sourceContextBuilder_ == null ? this.sourceContext_ : this.sourceContextBuilder_.build();
                to_bitField0_ |= 1;
            }
            ...
            if ((from_bitField0_ & 0x40) != 0) {
                result2.edition_ = this.edition_;
            }
