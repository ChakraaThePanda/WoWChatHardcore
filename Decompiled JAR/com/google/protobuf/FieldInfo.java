...
implements Comparable<FieldInfo> {
    ...
    public static FieldInfo forField(Field field2, int fieldNumber, FieldType fieldType, boolean enforceUtf8) {
        ...
        return new FieldInfo(field2, fieldNumber, fieldType, null, null, 0, false, enforceUtf8, null, null, null, null, null);
    }

    public static FieldInfo forPackedField(Field field2, int fieldNumber, FieldType fieldType, Field cachedSizeField) {
        FieldInfo.checkFieldNumber(fieldNumber);
        Internal.checkNotNull(field2, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        if (fieldType == FieldType.MESSAGE_LIST || fieldType == FieldType.GROUP_LIST) {
        ...
        return new FieldInfo(field2, fieldNumber, fieldType, null, null, 0, false, false, null, null, null, null, cachedSizeField);
    }

    public static FieldInfo forRepeatedMessageField(Field field2, int fieldNumber, FieldType fieldType, Class<?> messageClass) {
        FieldInfo.checkFieldNumber(fieldNumber);
        Internal.checkNotNull(field2, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(messageClass, "messageClass");
        return new FieldInfo(field2, fieldNumber, fieldType, messageClass, null, 0, false, false, null, null, null, null, null);
    }

    public static FieldInfo forFieldWithEnumVerifier(Field field2, int fieldNumber, FieldType fieldType, Internal.EnumVerifier enumVerifier) {
        FieldInfo.checkFieldNumber(fieldNumber);
        Internal.checkNotNull(field2, "field");
        return new FieldInfo(field2, fieldNumber, fieldType, null, null, 0, false, false, null, null, null, enumVerifier, null);
    }

    public static FieldInfo forPackedFieldWithEnumVerifier(Field field2, int fieldNumber, FieldType fieldType, Internal.EnumVerifier enumVerifier, Field cachedSizeField) {
        FieldInfo.checkFieldNumber(fieldNumber);
        Internal.checkNotNull(field2, "field");
        return new FieldInfo(field2, fieldNumber, fieldType, null, null, 0, false, false, null, null, null, enumVerifier, cachedSizeField);
    }

    public static FieldInfo forExplicitPresenceField(Field field2, int fieldNumber, FieldType fieldType, Field presenceField, int presenceMask, boolean enforceUtf8, Internal.EnumVerifier enumVerifier) {
        FieldInfo.checkFieldNumber(fieldNumber);
        Internal.checkNotNull(field2, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        ...
        return new FieldInfo(field2, fieldNumber, fieldType, null, presenceField, presenceMask, false, enforceUtf8, null, null, null, enumVerifier, null);
    }
    ...
    public static FieldInfo forLegacyRequiredField(Field field2, int fieldNumber, FieldType fieldType, Field presenceField, int presenceMask, boolean enforceUtf8, Internal.EnumVerifier enumVerifier) {
        FieldInfo.checkFieldNumber(fieldNumber);
        Internal.checkNotNull(field2, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(presenceField, "presenceField");
        ...
        return new FieldInfo(field2, fieldNumber, fieldType, null, presenceField, presenceMask, true, enforceUtf8, null, null, null, enumVerifier, null);
    }

    public static FieldInfo forMapField(Field field2, int fieldNumber, Object mapDefaultEntry, Internal.EnumVerifier enumVerifier) {
        Internal.checkNotNull(mapDefaultEntry, "mapDefaultEntry");
        FieldInfo.checkFieldNumber(fieldNumber);
        Internal.checkNotNull(field2, "field");
        return new FieldInfo(field2, fieldNumber, FieldType.MAP, null, null, 0, false, true, null, null, mapDefaultEntry, enumVerifier, null);
    }

    private FieldInfo(Field field2, int fieldNumber, FieldType type, Class<?> messageClass, Field presenceField, int presenceMask, boolean required, boolean enforceUtf8, OneofInfo oneof, Class<?> oneofStoredType, Object mapDefaultEntry, Internal.EnumVerifier enumVerifier, Field cachedSizeField) {
        this.field = field2;
        this.type = type;
