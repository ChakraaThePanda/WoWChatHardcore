...
implements Schema<T> {
        ...
        if ((fieldCount = next) == 0) {
            ...
            if ((next = info.charAt(i++)) >= 55296) {
                ...
                while (true) {
                    ...
                    next = c;
                    if (c < '\ud800') break;
                    result4 |= (next & 0x1FFF) << shift;
                    shift += 13;
                }
                next = result4 | next << shift;
            }
            oneofCount = next;
        ...
        while (i < length) {
            ...
            if ((next = (int)info.charAt(i++)) >= 55296) {
                ...
                while (true) {
                    ...
                    next = c;
                    if (c < '\ud800') break;
                    result5 |= (next & 0x1FFF) << shift;
                    shift += 13;
                }
                next = result5 | next << shift;
            }
            ...
            if (fieldType >= 51) {
                ...
                if ((next = (int)info.charAt(i++)) >= 55296) {
                    ...
                    while (true) {
                        ...
                        next = c;
                        if (c < '\ud800') break;
                        result6 |= (next & 0x1FFF) << shift2;
                        shift2 += 13;
                    }
                    next = result6 | next << shift2;
                }
                int oneofIndex = next;
                ...
                boolean hasHasBit;
                Field field2 = MessageSchema.reflectField(messageClass, (String)messageInfoObjects[objectsPosition++]);
                if (fieldType == 9 || fieldType == 17) {
                    objects[bufferIndex / 3 * 2 + 1] = field2.getType();
                ...
                fieldOffset = (int)unsafe.objectFieldOffset(field2);
                ...
                if (hasHasBit && fieldType <= 17) {
                    ...
                    Object o;
                    if ((next = (int)info.charAt(i++)) >= 55296) {
                        int result7 = next & 0x1FFF;
                        int shift3 = 13;
                        while (true) {
                            char c = info.charAt(i++);
                            next = c;
                            if (c < '\ud800') break;
                            result7 |= (next & 0x1FFF) << shift3;
                            shift3 += 13;
                        }
                        next = result7 | next << shift3;
                    }
    ...
    private static Field reflectField(Class<?> messageClass, String fieldName) {
        try {
            ...
            Object[] fields;
            for (Field field2 : fields = messageClass.getDeclaredFields()) {
                if (!fieldName.equals(field2.getName())) continue;
                return field2;
            }
        ...
        block71: for (int i = 0; i < this.buffer.length; i += 3) {
            ...
            if (fieldType <= 17) {
                if (presenceOrCachedSizeFieldOffset != currentPresenceFieldOffset) {
                    ...
                    currentPresenceField = currentPresenceFieldOffset == 1048575 ? 0 : unsafe.getInt(message, (long)currentPresenceFieldOffset);
                }
        ...
        block71: for (int pos = 0; pos < bufferLength; pos += 3) {
            ...
            if (fieldType <= 17) {
                ...
                if (presenceFieldOffset != currentPresenceFieldOffset) {
                    ...
                    currentPresenceField = currentPresenceFieldOffset == 1048575 ? 0 : unsafe.getInt(message, (long)presenceFieldOffset);
                }
                presenceMask = 1 << (presenceMaskAndOffset >>> 20);
            }
    ...
    private int parseOneofField(T message, byte[] data, int position, int limit, int tag, int number, int wireType, int typeAndOffset, int fieldType, long fieldOffset, int bufferPosition, ArrayDecoders.Registers registers) throws IOException {
        ...
        switch (fieldType) {
            case 51: {
                if (wireType != 1) break;
                unsafe.putObject(message, fieldOffset, (Object)ArrayDecoders.decodeDouble(data, position));
                position += 8;
            ...
            case 52: {
                if (wireType != 5) break;
                unsafe.putObject(message, fieldOffset, (Object)Float.valueOf(ArrayDecoders.decodeFloat(data, position)));
                position += 4;
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            ...
            case 54: {
                if (wireType != 0) break;
                position = ArrayDecoders.decodeVarint64(data, position, registers);
                unsafe.putObject(message, fieldOffset, (Object)registers.long1);
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            case 55: 
            case 62: {
                if (wireType != 0) break;
                position = ArrayDecoders.decodeVarint32(data, position, registers);
                unsafe.putObject(message, fieldOffset, (Object)registers.int1);
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            case 56: 
            case 65: {
                if (wireType != 1) break;
                unsafe.putObject(message, fieldOffset, (Object)ArrayDecoders.decodeFixed64(data, position));
                position += 8;
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            ...
            case 64: {
                if (wireType != 5) break;
                unsafe.putObject(message, fieldOffset, (Object)ArrayDecoders.decodeFixed32(data, position));
                position += 4;
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            case 58: {
                if (wireType != 0) break;
                position = ArrayDecoders.decodeVarint64(data, position, registers);
                unsafe.putObject(message, fieldOffset, (Object)(registers.long1 != 0L ? 1 : 0));
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            case 59: {
                ...
                int length = registers.int1;
                if (length == 0) {
                    unsafe.putObject(message, fieldOffset, (Object)"");
                } else {
                    ...
                    unsafe.putObject(message, fieldOffset, (Object)value);
                    position += length;
                }
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            ...
            case 63: {
                ...
                if (enumVerifier == null || enumVerifier.isInRange(enumValue)) {
                    unsafe.putObject(message, fieldOffset, (Object)enumValue);
                    unsafe.putInt(message, oneofCaseOffset, number);
                    break;
                }
            ...
            case 66: {
                if (wireType != 0) break;
                position = ArrayDecoders.decodeVarint32(data, position, registers);
                unsafe.putObject(message, fieldOffset, (Object)CodedInputStream.decodeZigZag32(registers.int1));
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            case 67: {
                if (wireType != 0) break;
                position = ArrayDecoders.decodeVarint64(data, position, registers);
                unsafe.putObject(message, fieldOffset, (Object)CodedInputStream.decodeZigZag64(registers.long1));
                unsafe.putInt(message, oneofCaseOffset, number);
                break;
            }
            case 68: {
    ...
    private void storeMessageField(T message, int pos, Object field2) {
        UNSAFE.putObject(message, MessageSchema.offset(this.typeAndOffsetAt(pos)), field2);
        this.setFieldPresent(message, pos);
    }
    ...
    private void storeOneofMessageField(T message, int fieldNumber, int pos, Object field2) {
        UNSAFE.putObject(message, MessageSchema.offset(this.typeAndOffsetAt(pos)), field2);
