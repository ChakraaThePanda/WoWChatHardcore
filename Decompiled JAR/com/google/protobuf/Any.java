...
implements AnyOrBuilder {
    ...
    public <T extends Message> T unpackSameTypeAs(T message) throws InvalidProtocolBufferException {
        ...
        this.cachedUnpackValue = result2 = message.getParserForType().parseFrom(this.getValue());
        return (T)result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Any.class.getName());
    ...
    implements AnyOrBuilder {
        ...
        private void buildPartial0(Any result2) {
