...
implements UInt32ValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", UInt32Value.class.getName());
    ...
    implements UInt32ValueOrBuilder {
        ...
        private void buildPartial0(UInt32Value result2) {
