...
implements EnumOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Enum.class.getName());
    ...
    implements EnumOrBuilder {
        ...
        private void buildPartialRepeatedFields(Enum result2) {
            if (this.enumvalueBuilder_ == null) {
        ...
        private void buildPartial0(Enum result2) {
