...
public abstract class CodedInputStream {
    ...
    extends CodedInputStream {
        ...
        public String readString() throws IOException {
            ...
            if (size > 0 && (long)size <= this.currentByteBufferLimit - this.currentByteBufferPos) {
                ...
                String result2 = new String(bytes, Internal.UTF_8);
            ...
            if (size > 0 && size <= this.remaining()) {
                ...
                String result3 = new String(bytes, Internal.UTF_8);
                return result3;
            }
            if (size == 0) {
                return "";
        ...
        public String readStringRequireUtf8() throws IOException {
            ...
            if (size > 0 && (long)size <= this.currentByteBufferLimit - this.currentByteBufferPos) {
                ...
                String result2 = Utf8.decodeUtf8(this.currentByteBuffer, bufferPos, size);
                this.currentByteBufferPos += (long)size;
                return result2;
            }
            if (size >= 0 && size <= this.remaining()) {
        ...
        public ByteString readBytes() throws IOException {
            ...
            if (size > 0 && (long)size <= this.currentByteBufferLimit - this.currentByteBufferPos) {
                if (this.immutable && this.enableAliasing) {
                    ...
                    ByteString result2 = ByteString.wrap(this.slice(idx, idx + size));
                    this.currentByteBufferPos += (long)size;
                    return result2;
                }
                byte[] bytes = new byte[size];
    ...
    extends CodedInputStream {
        ...
        public String readString() throws IOException {
            ...
            if (size <= this.bufferSize) {
                ...
                String result3 = new String(this.buffer, this.pos, size, Internal.UTF_8);
                this.pos += size;
                return result3;
            }
        ...
        public ByteString readBytes() throws IOException {
            ...
            if (size <= this.bufferSize - this.pos && size > 0) {
                ByteString result2 = ByteString.copyFrom(this.buffer, this.pos, size);
                this.pos += size;
                return result2;
            }
            if (size == 0) {
        ...
        public byte[] readByteArray() throws IOException {
            int size = this.readRawVarint32();
            if (size <= this.bufferSize - this.pos && size > 0) {
                byte[] result2 = Arrays.copyOfRange(this.buffer, this.pos, this.pos + size);
                this.pos += size;
                return result2;
            }
            if (size < 0) {
        ...
        public ByteBuffer readByteBuffer() throws IOException {
            int size = this.readRawVarint32();
            if (size <= this.bufferSize - this.pos && size > 0) {
                ByteBuffer result2 = ByteBuffer.wrap(Arrays.copyOfRange(this.buffer, this.pos, this.pos + size));
                this.pos += size;
                return result2;
            }
            if (size == 0) {
        ...
        private byte[] readRawBytesSlowPath(int size, boolean ensureNoLeakedReferences) throws IOException {
            byte[] result2 = this.readRawBytesSlowPathOneChunk(size);
            if (result2 != null) {
                return ensureNoLeakedReferences ? (byte[])result2.clone() : result2;
            }
        ...
        private ByteString readBytesSlowPath(int size) throws IOException {
            byte[] result2 = this.readRawBytesSlowPathOneChunk(size);
            if (result2 != null) {
                return ByteString.copyFrom(result2);
            }
            int originalBufferPos = this.pos;
            int bufferedBytes = this.bufferSize - this.pos;
            this.totalBytesRetired += this.bufferSize;
    ...
    extends CodedInputStream {
        ...
        public String readStringRequireUtf8() throws IOException {
            ...
            if (size > 0 && size <= this.remaining()) {
                ...
                String result2 = Utf8.decodeUtf8(this.buffer, bufferPos, size);
                this.pos += (long)size;
                return result2;
            }
            if (size == 0) {
        ...
        public ByteString readBytes() throws IOException {
            ...
            if (size > 0 && size <= this.remaining()) {
                if (this.immutable && this.enableAliasing) {
                    ByteBuffer result2 = this.slice(this.pos, this.pos + (long)size);
                    this.pos += (long)size;
    ...
    extends CodedInputStream {
        ...
        public String readStringRequireUtf8() throws IOException {
            int size = this.readRawVarint32();
            if (size > 0 && size <= this.limit - this.pos) {
                String result2 = Utf8.decodeUtf8(this.buffer, this.pos, size);
                this.pos += size;
                return result2;
            }
            if (size == 0) {
        ...
        public ByteString readBytes() throws IOException {
            int size = this.readRawVarint32();
            if (size > 0 && size <= this.limit - this.pos) {
                ByteString result2 = this.immutable && this.enableAliasing ? ByteString.wrap(this.buffer, this.pos, size) : ByteString.copyFrom(this.buffer, this.pos, size);
                this.pos += size;
                return result2;
            }
            if (size == 0) {
        ...
        public ByteBuffer readByteBuffer() throws IOException {
            int size = this.readRawVarint32();
            if (size > 0 && size <= this.limit - this.pos) {
                ByteBuffer result2 = !this.immutable && this.enableAliasing ? ByteBuffer.wrap(this.buffer, this.pos, size).slice() : ByteBuffer.wrap(Arrays.copyOfRange(this.buffer, this.pos, this.pos + size));
                this.pos += size;
                return result2;
            }
            if (size == 0) {
