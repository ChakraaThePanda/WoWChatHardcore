...
public final class Registry {
    ...
    private static Set<Class<?>> createAllowedPrimitives() {
        ...
        result2.add(Aead.class);
        result2.add(DeterministicAead.class);
        result2.add(StreamingAead.class);
        result2.add(HybridEncrypt.class);
        result2.add(HybridDecrypt.class);
        result2.add(Mac.class);
        result2.add(Prf.class);
        result2.add(PublicKeySign.class);
        result2.add(PublicKeyVerify.class);
        return result2;
    }
