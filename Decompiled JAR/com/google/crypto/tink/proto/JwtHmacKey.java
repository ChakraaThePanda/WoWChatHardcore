...
implements JwtHmacKeyOrBuilder {
    ...
    public JwtHmacAlgorithm getAlgorithm() {
        JwtHmacAlgorithm result2 = JwtHmacAlgorithm.forNumber(this.algorithm_);
        return result2 == null ? JwtHmacAlgorithm.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtHmacKey.class.getName());
    ...
    implements JwtHmacKeyOrBuilder {
        ...
        public JwtHmacKey build() {
            JwtHmacKey result2 = this.buildPartial();
        ...
        public JwtHmacKey buildPartial() {
            JwtHmacKey result2 = new JwtHmacKey(this);
        ...
        private void buildPartial0(JwtHmacKey result2) {
            ...
            if ((from_bitField0_ & 4) != 0) {
                result2.keyValue_ = this.keyValue_;
            }
            int to_bitField0_ = 0;
