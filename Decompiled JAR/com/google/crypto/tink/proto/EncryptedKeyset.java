...
implements EncryptedKeysetOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EncryptedKeyset.class.getName());
    ...
    implements EncryptedKeysetOrBuilder {
        ...
        public EncryptedKeyset build() {
            EncryptedKeyset result2 = this.buildPartial();
        ...
        public EncryptedKeyset buildPartial() {
            EncryptedKeyset result2 = new EncryptedKeyset(this);
        ...
        private void buildPartial0(EncryptedKeyset result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.encryptedKeyset_ = this.encryptedKeyset_;
            }
            int to_bitField0_ = 0;
            if ((from_bitField0_ & 2) != 0) {
                result2.keysetInfo_ = this.keysetInfoBuilder_ == null ? this.keysetInfo_ : this.keysetInfoBuilder_.build();
                to_bitField0_ |= 1;
            }
        ...
        public KeysetInfo.Builder getKeysetInfoBuilder() {
            this.bitField0_ |= 2;
            this.onChanged();
            return this.getKeysetInfoFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<KeysetInfo, KeysetInfo.Builder, KeysetInfoOrBuilder> getKeysetInfoFieldBuilder() {
            if (this.keysetInfoBuilder_ == null) {
