...
implements EciesAeadDemParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EciesAeadDemParams.class.getName());
    ...
    implements EciesAeadDemParamsOrBuilder {
        ...
        public EciesAeadDemParams build() {
            EciesAeadDemParams result2 = this.buildPartial();
        ...
        public EciesAeadDemParams buildPartial() {
            EciesAeadDemParams result2 = new EciesAeadDemParams(this);
        ...
        private void buildPartial0(EciesAeadDemParams result2) {
            int from_bitField0_ = this.bitField0_;
            int to_bitField0_ = 0;
            if ((from_bitField0_ & 1) != 0) {
                result2.aeadDem_ = this.aeadDemBuilder_ == null ? this.aeadDem_ : this.aeadDemBuilder_.build();
                to_bitField0_ |= 1;
            }
        ...
        public KeyTemplate.Builder getAeadDemBuilder() {
            this.bitField0_ |= 1;
            this.onChanged();
            return this.getAeadDemFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<KeyTemplate, KeyTemplate.Builder, KeyTemplateOrBuilder> getAeadDemFieldBuilder() {
            if (this.aeadDemBuilder_ == null) {
