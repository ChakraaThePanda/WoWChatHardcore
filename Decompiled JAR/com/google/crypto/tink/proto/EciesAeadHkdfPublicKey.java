...
implements EciesAeadHkdfPublicKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EciesAeadHkdfPublicKey.class.getName());
    ...
    implements EciesAeadHkdfPublicKeyOrBuilder {
        ...
        public EciesAeadHkdfPublicKey build() {
            EciesAeadHkdfPublicKey result2 = this.buildPartial();
        ...
        public EciesAeadHkdfPublicKey buildPartial() {
            EciesAeadHkdfPublicKey result2 = new EciesAeadHkdfPublicKey(this);
        ...
        private void buildPartial0(EciesAeadHkdfPublicKey result2) {
