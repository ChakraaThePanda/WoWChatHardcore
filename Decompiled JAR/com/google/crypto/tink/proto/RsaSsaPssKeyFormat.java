...
implements RsaSsaPssKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPssKeyFormat.class.getName());
    ...
    implements RsaSsaPssKeyFormatOrBuilder {
        ...
        public RsaSsaPssKeyFormat build() {
            RsaSsaPssKeyFormat result2 = this.buildPartial();
        ...
        public RsaSsaPssKeyFormat buildPartial() {
            RsaSsaPssKeyFormat result2 = new RsaSsaPssKeyFormat(this);
        ...
        private void buildPartial0(RsaSsaPssKeyFormat result2) {
        ...
        private SingleFieldBuilder<RsaSsaPssParams, RsaSsaPssParams.Builder, RsaSsaPssParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
