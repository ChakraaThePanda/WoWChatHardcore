...
implements EcdsaPrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EcdsaPrivateKey.class.getName());
    ...
    implements EcdsaPrivateKeyOrBuilder {
        ...
        public EcdsaPrivateKey build() {
            EcdsaPrivateKey result2 = this.buildPartial();
        ...
        public EcdsaPrivateKey buildPartial() {
            EcdsaPrivateKey result2 = new EcdsaPrivateKey(this);
        ...
        private void buildPartial0(EcdsaPrivateKey result2) {
        ...
        private SingleFieldBuilder<EcdsaPublicKey, EcdsaPublicKey.Builder, EcdsaPublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
