...
implements AesEaxParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesEaxParams.class.getName());
    ...
    implements AesEaxParamsOrBuilder {
        ...
        public AesEaxParams build() {
            AesEaxParams result2 = this.buildPartial();
        ...
        public AesEaxParams buildPartial() {
            AesEaxParams result2 = new AesEaxParams(this);
        ...
        private void buildPartial0(AesEaxParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.ivSize_ = this.ivSize_;
            }
        }
