...
implements HpkePublicKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HpkePublicKey.class.getName());
    ...
    implements HpkePublicKeyOrBuilder {
        ...
        public HpkePublicKey build() {
            HpkePublicKey result2 = this.buildPartial();
        ...
        public HpkePublicKey buildPartial() {
            HpkePublicKey result2 = new HpkePublicKey(this);
        ...
        private void buildPartial0(HpkePublicKey result2) {
            ...
            if ((from_bitField0_ & 4) != 0) {
                result2.publicKey_ = this.publicKey_;
            }
        ...
        private SingleFieldBuilder<HpkeParams, HpkeParams.Builder, HpkeParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
