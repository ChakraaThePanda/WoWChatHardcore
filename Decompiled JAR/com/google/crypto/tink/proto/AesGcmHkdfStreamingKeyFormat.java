...
implements AesGcmHkdfStreamingKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesGcmHkdfStreamingKeyFormat.class.getName());
    ...
    implements AesGcmHkdfStreamingKeyFormatOrBuilder {
        ...
        public AesGcmHkdfStreamingKeyFormat build() {
            AesGcmHkdfStreamingKeyFormat result2 = this.buildPartial();
        ...
        public AesGcmHkdfStreamingKeyFormat buildPartial() {
            AesGcmHkdfStreamingKeyFormat result2 = new AesGcmHkdfStreamingKeyFormat(this);
        ...
        private void buildPartial0(AesGcmHkdfStreamingKeyFormat result2) {
        ...
        private SingleFieldBuilder<AesGcmHkdfStreamingParams, AesGcmHkdfStreamingParams.Builder, AesGcmHkdfStreamingParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
