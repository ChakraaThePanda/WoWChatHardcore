...
implements XAesGcmKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", XAesGcmKeyFormat.class.getName());
    ...
    implements XAesGcmKeyFormatOrBuilder {
        ...
        public XAesGcmKeyFormat build() {
            XAesGcmKeyFormat result2 = this.buildPartial();
        ...
        public XAesGcmKeyFormat buildPartial() {
            XAesGcmKeyFormat result2 = new XAesGcmKeyFormat(this);
        ...
        private void buildPartial0(XAesGcmKeyFormat result2) {
