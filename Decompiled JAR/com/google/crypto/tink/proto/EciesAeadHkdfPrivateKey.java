...
implements EciesAeadHkdfPrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EciesAeadHkdfPrivateKey.class.getName());
    ...
    implements EciesAeadHkdfPrivateKeyOrBuilder {
        ...
        public EciesAeadHkdfPrivateKey build() {
            EciesAeadHkdfPrivateKey result2 = this.buildPartial();
        ...
        public EciesAeadHkdfPrivateKey buildPartial() {
            EciesAeadHkdfPrivateKey result2 = new EciesAeadHkdfPrivateKey(this);
        ...
        private void buildPartial0(EciesAeadHkdfPrivateKey result2) {
        ...
        private SingleFieldBuilder<EciesAeadHkdfPublicKey, EciesAeadHkdfPublicKey.Builder, EciesAeadHkdfPublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
