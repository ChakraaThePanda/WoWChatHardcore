...
implements XChaCha20Poly1305KeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", XChaCha20Poly1305KeyFormat.class.getName());
    ...
    implements XChaCha20Poly1305KeyFormatOrBuilder {
        ...
        public XChaCha20Poly1305KeyFormat build() {
            XChaCha20Poly1305KeyFormat result2 = this.buildPartial();
        ...
        public XChaCha20Poly1305KeyFormat buildPartial() {
            XChaCha20Poly1305KeyFormat result2 = new XChaCha20Poly1305KeyFormat(this);
        ...
        private void buildPartial0(XChaCha20Poly1305KeyFormat result2) {
