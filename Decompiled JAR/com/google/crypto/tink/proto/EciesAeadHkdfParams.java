...
implements EciesAeadHkdfParamsOrBuilder {
    ...
    public EcPointFormat getEcPointFormat() {
        EcPointFormat result2 = EcPointFormat.forNumber(this.ecPointFormat_);
        return result2 == null ? EcPointFormat.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EciesAeadHkdfParams.class.getName());
    ...
    implements EciesAeadHkdfParamsOrBuilder {
        ...
        public EciesAeadHkdfParams build() {
            EciesAeadHkdfParams result2 = this.buildPartial();
        ...
        public EciesAeadHkdfParams buildPartial() {
            EciesAeadHkdfParams result2 = new EciesAeadHkdfParams(this);
        ...
        private void buildPartial0(EciesAeadHkdfParams result2) {
            int from_bitField0_ = this.bitField0_;
            int to_bitField0_ = 0;
            if ((from_bitField0_ & 1) != 0) {
                result2.kemParams_ = this.kemParamsBuilder_ == null ? this.kemParams_ : this.kemParamsBuilder_.build();
                to_bitField0_ |= 1;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.demParams_ = this.demParamsBuilder_ == null ? this.demParams_ : this.demParamsBuilder_.build();
                to_bitField0_ |= 2;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.ecPointFormat_ = this.ecPointFormat_;
            }
        ...
        public EciesHkdfKemParams.Builder getKemParamsBuilder() {
            this.bitField0_ |= 1;
            this.onChanged();
            return this.getKemParamsFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<EciesHkdfKemParams, EciesHkdfKemParams.Builder, EciesHkdfKemParamsOrBuilder> getKemParamsFieldBuilder() {
            if (this.kemParamsBuilder_ == null) {
        ...
        public EciesAeadDemParams.Builder getDemParamsBuilder() {
            this.bitField0_ |= 2;
            this.onChanged();
            return this.getDemParamsFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<EciesAeadDemParams, EciesAeadDemParams.Builder, EciesAeadDemParamsOrBuilder> getDemParamsFieldBuilder() {
            if (this.demParamsBuilder_ == null) {
