...
implements AesCtrHmacStreamingKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCtrHmacStreamingKey.class.getName());
    ...
    implements AesCtrHmacStreamingKeyOrBuilder {
        ...
        public AesCtrHmacStreamingKey build() {
            AesCtrHmacStreamingKey result2 = this.buildPartial();
        ...
        public AesCtrHmacStreamingKey buildPartial() {
            AesCtrHmacStreamingKey result2 = new AesCtrHmacStreamingKey(this);
        ...
        private void buildPartial0(AesCtrHmacStreamingKey result2) {
