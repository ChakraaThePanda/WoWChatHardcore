...
implements HmacKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacKey.class.getName());
    ...
    implements HmacKeyOrBuilder {
        ...
        public HmacKey build() {
            HmacKey result2 = this.buildPartial();
        ...
        public HmacKey buildPartial() {
            HmacKey result2 = new HmacKey(this);
        ...
        private void buildPartial0(HmacKey result2) {
