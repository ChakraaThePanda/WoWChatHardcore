...
implements AesCtrHmacAeadKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCtrHmacAeadKey.class.getName());
    ...
    implements AesCtrHmacAeadKeyOrBuilder {
        ...
        public AesCtrHmacAeadKey build() {
            AesCtrHmacAeadKey result2 = this.buildPartial();
        ...
        public AesCtrHmacAeadKey buildPartial() {
            AesCtrHmacAeadKey result2 = new AesCtrHmacAeadKey(this);
        ...
        private void buildPartial0(AesCtrHmacAeadKey result2) {
            ...
            if ((from_bitField0_ & 2) != 0) {
                result2.aesCtrKey_ = this.aesCtrKeyBuilder_ == null ? this.aesCtrKey_ : this.aesCtrKeyBuilder_.build();
                to_bitField0_ |= 1;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.hmacKey_ = this.hmacKeyBuilder_ == null ? this.hmacKey_ : this.hmacKeyBuilder_.build();
                to_bitField0_ |= 2;
            }
        ...
        public AesCtrKey.Builder getAesCtrKeyBuilder() {
            this.bitField0_ |= 2;
            this.onChanged();
            return this.getAesCtrKeyFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<AesCtrKey, AesCtrKey.Builder, AesCtrKeyOrBuilder> getAesCtrKeyFieldBuilder() {
            if (this.aesCtrKeyBuilder_ == null) {
        ...
        public HmacKey.Builder getHmacKeyBuilder() {
            this.bitField0_ |= 4;
            this.onChanged();
            return this.getHmacKeyFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<HmacKey, HmacKey.Builder, HmacKeyOrBuilder> getHmacKeyFieldBuilder() {
            if (this.hmacKeyBuilder_ == null) {
