...
implements JwtRsaSsaPssPrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtRsaSsaPssPrivateKey.class.getName());
    ...
    implements JwtRsaSsaPssPrivateKeyOrBuilder {
        ...
        public JwtRsaSsaPssPrivateKey build() {
            JwtRsaSsaPssPrivateKey result2 = this.buildPartial();
        ...
        public JwtRsaSsaPssPrivateKey buildPartial() {
            JwtRsaSsaPssPrivateKey result2 = new JwtRsaSsaPssPrivateKey(this);
        ...
        private void buildPartial0(JwtRsaSsaPssPrivateKey result2) {
        ...
        private SingleFieldBuilder<JwtRsaSsaPssPublicKey, JwtRsaSsaPssPublicKey.Builder, JwtRsaSsaPssPublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
