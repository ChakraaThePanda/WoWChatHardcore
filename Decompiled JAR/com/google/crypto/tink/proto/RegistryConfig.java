...
implements RegistryConfigOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RegistryConfig.class.getName());
    ...
    implements RegistryConfigOrBuilder {
        ...
        public RegistryConfig build() {
            RegistryConfig result2 = this.buildPartial();
        ...
        public RegistryConfig buildPartial() {
            RegistryConfig result2 = new RegistryConfig(this);
        ...
        private void buildPartialRepeatedFields(RegistryConfig result2) {
            if (this.entryBuilder_ == null) {
                if ((this.bitField0_ & 2) != 0) {
                    this.entry_ = Collections.unmodifiableList(this.entry_);
                    this.bitField0_ &= 0xFFFFFFFD;
                }
                result2.entry_ = this.entry_;
            } else {
                result2.entry_ = this.entryBuilder_.build();
            }
        }

        private void buildPartial0(RegistryConfig result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.configName_ = this.configName_;
            }
        }
        ...
        public Builder mergeFrom(RegistryConfig other) {
            ...
            if (this.entryBuilder_ == null) {
                ...
                if (this.entryBuilder_.isEmpty()) {
                    ...
                    this.entry_ = other.entry_;
                    this.bitField0_ &= 0xFFFFFFFD;
                    this.entryBuilder_ = alwaysUseFieldBuilders ? this.getEntryFieldBuilder() : null;
                } else {
        ...
        public Builder addAllEntry(Iterable<? extends KeyTypeEntry> values2) {
            if (this.entryBuilder_ == null) {
                this.ensureEntryIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.entry_);
                this.onChanged();
            } else {
                this.entryBuilder_.addAllMessages(values2);
            }
            return this;
        }
        ...
        public KeyTypeEntry.Builder addEntryBuilder() {
            return this.getEntryFieldBuilder().addBuilder(KeyTypeEntry.getDefaultInstance());
        }

        public KeyTypeEntry.Builder addEntryBuilder(int index) {
            return this.getEntryFieldBuilder().addBuilder(index, KeyTypeEntry.getDefaultInstance());
        }
        ...
        private RepeatedFieldBuilder<KeyTypeEntry, KeyTypeEntry.Builder, KeyTypeEntryOrBuilder> getEntryFieldBuilder() {
            if (this.entryBuilder_ == null) {
