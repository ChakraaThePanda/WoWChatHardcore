...
implements HmacPrfParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacPrfParams.class.getName());
    ...
    implements HmacPrfParamsOrBuilder {
        ...
        public HmacPrfParams build() {
            HmacPrfParams result2 = this.buildPartial();
        ...
        public HmacPrfParams buildPartial() {
            HmacPrfParams result2 = new HmacPrfParams(this);
        ...
        private void buildPartial0(HmacPrfParams result2) {
