...
implements Ed25519KeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Ed25519KeyFormat.class.getName());
    ...
    implements Ed25519KeyFormatOrBuilder {
        ...
        public Ed25519KeyFormat build() {
            Ed25519KeyFormat result2 = this.buildPartial();
        ...
        public Ed25519KeyFormat buildPartial() {
            Ed25519KeyFormat result2 = new Ed25519KeyFormat(this);
        ...
        private void buildPartial0(Ed25519KeyFormat result2) {
