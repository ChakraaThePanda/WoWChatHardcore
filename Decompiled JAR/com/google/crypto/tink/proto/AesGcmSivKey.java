...
implements AesGcmSivKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesGcmSivKey.class.getName());
    ...
    implements AesGcmSivKeyOrBuilder {
        ...
        public AesGcmSivKey build() {
            AesGcmSivKey result2 = this.buildPartial();
        ...
        public AesGcmSivKey buildPartial() {
            AesGcmSivKey result2 = new AesGcmSivKey(this);
        ...
        private void buildPartial0(AesGcmSivKey result2) {
