...
implements AesCmacParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCmacParams.class.getName());
    ...
    implements AesCmacParamsOrBuilder {
        ...
        public AesCmacParams build() {
            AesCmacParams result2 = this.buildPartial();
        ...
        public AesCmacParams buildPartial() {
            AesCmacParams result2 = new AesCmacParams(this);
        ...
        private void buildPartial0(AesCmacParams result2) {
