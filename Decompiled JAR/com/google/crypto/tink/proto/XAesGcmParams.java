...
implements XAesGcmParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", XAesGcmParams.class.getName());
    ...
    implements XAesGcmParamsOrBuilder {
        ...
        public XAesGcmParams build() {
            XAesGcmParams result2 = this.buildPartial();
        ...
        public XAesGcmParams buildPartial() {
            XAesGcmParams result2 = new XAesGcmParams(this);
        ...
        private void buildPartial0(XAesGcmParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.saltSize_ = this.saltSize_;
            }
        }
