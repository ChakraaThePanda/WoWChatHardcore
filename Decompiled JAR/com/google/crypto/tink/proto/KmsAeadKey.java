...
implements KmsAeadKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KmsAeadKey.class.getName());
    ...
    implements KmsAeadKeyOrBuilder {
        ...
        public KmsAeadKey build() {
            KmsAeadKey result2 = this.buildPartial();
        ...
        public KmsAeadKey buildPartial() {
            KmsAeadKey result2 = new KmsAeadKey(this);
        ...
        private void buildPartial0(KmsAeadKey result2) {
        ...
        private SingleFieldBuilder<KmsAeadKeyFormat, KmsAeadKeyFormat.Builder, KmsAeadKeyFormatOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
