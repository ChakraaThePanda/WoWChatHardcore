...
implements HmacKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacKeyFormat.class.getName());
    ...
    implements HmacKeyFormatOrBuilder {
        ...
        public HmacKeyFormat build() {
            HmacKeyFormat result2 = this.buildPartial();
        ...
        public HmacKeyFormat buildPartial() {
            HmacKeyFormat result2 = new HmacKeyFormat(this);
        ...
        private void buildPartial0(HmacKeyFormat result2) {
        ...
        private SingleFieldBuilder<HmacParams, HmacParams.Builder, HmacParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
