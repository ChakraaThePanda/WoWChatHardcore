...
implements RsaSsaPkcs1KeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPkcs1KeyFormat.class.getName());
    ...
    implements RsaSsaPkcs1KeyFormatOrBuilder {
        ...
        public RsaSsaPkcs1KeyFormat build() {
            RsaSsaPkcs1KeyFormat result2 = this.buildPartial();
        ...
        public RsaSsaPkcs1KeyFormat buildPartial() {
            RsaSsaPkcs1KeyFormat result2 = new RsaSsaPkcs1KeyFormat(this);
        ...
        private void buildPartial0(RsaSsaPkcs1KeyFormat result2) {
            ...
            if ((from_bitField0_ & 2) != 0) {
                result2.modulusSizeInBits_ = this.modulusSizeInBits_;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.publicExponent_ = this.publicExponent_;
            }
        ...
        private SingleFieldBuilder<RsaSsaPkcs1Params, RsaSsaPkcs1Params.Builder, RsaSsaPkcs1ParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
