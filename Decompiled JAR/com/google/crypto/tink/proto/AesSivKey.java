...
implements AesSivKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesSivKey.class.getName());
    ...
    implements AesSivKeyOrBuilder {
        ...
        public AesSivKey build() {
            AesSivKey result2 = this.buildPartial();
        ...
        public AesSivKey buildPartial() {
            AesSivKey result2 = new AesSivKey(this);
        ...
        private void buildPartial0(AesSivKey result2) {
