...
implements EcdsaPublicKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EcdsaPublicKey.class.getName());
    ...
    implements EcdsaPublicKeyOrBuilder {
        ...
        public EcdsaPublicKey build() {
            EcdsaPublicKey result2 = this.buildPartial();
        ...
        public EcdsaPublicKey buildPartial() {
            EcdsaPublicKey result2 = new EcdsaPublicKey(this);
        ...
        private void buildPartial0(EcdsaPublicKey result2) {
        ...
        private SingleFieldBuilder<EcdsaParams, EcdsaParams.Builder, EcdsaParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
