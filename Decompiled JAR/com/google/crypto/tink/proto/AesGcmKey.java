...
implements AesGcmKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesGcmKey.class.getName());
    ...
    implements AesGcmKeyOrBuilder {
        ...
        public AesGcmKey build() {
            AesGcmKey result2 = this.buildPartial();
        ...
        public AesGcmKey buildPartial() {
            AesGcmKey result2 = new AesGcmKey(this);
        ...
        private void buildPartial0(AesGcmKey result2) {
