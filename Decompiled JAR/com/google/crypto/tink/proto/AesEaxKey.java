...
implements AesEaxKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesEaxKey.class.getName());
    ...
    implements AesEaxKeyOrBuilder {
        ...
        public AesEaxKey build() {
            AesEaxKey result2 = this.buildPartial();
        ...
        public AesEaxKey buildPartial() {
            AesEaxKey result2 = new AesEaxKey(this);
        ...
        private void buildPartial0(AesEaxKey result2) {
