...
implements HkdfPrfKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HkdfPrfKey.class.getName());
    ...
    implements HkdfPrfKeyOrBuilder {
        ...
        public HkdfPrfKey build() {
            HkdfPrfKey result2 = this.buildPartial();
        ...
        public HkdfPrfKey buildPartial() {
            HkdfPrfKey result2 = new HkdfPrfKey(this);
        ...
        private void buildPartial0(HkdfPrfKey result2) {
