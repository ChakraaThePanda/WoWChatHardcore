...
implements EcdsaParamsOrBuilder {
    ...
    public HashType getHashType() {
        HashType result2 = HashType.forNumber(this.hashType_);
    ...
    public EllipticCurveType getCurve() {
        EllipticCurveType result2 = EllipticCurveType.forNumber(this.curve_);
        return result2 == null ? EllipticCurveType.UNRECOGNIZED : result2;
    }
    ...
    public EcdsaSignatureEncoding getEncoding() {
        EcdsaSignatureEncoding result2 = EcdsaSignatureEncoding.forNumber(this.encoding_);
        return result2 == null ? EcdsaSignatureEncoding.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EcdsaParams.class.getName());
    ...
    implements EcdsaParamsOrBuilder {
        ...
        public EcdsaParams build() {
            EcdsaParams result2 = this.buildPartial();
        ...
        public EcdsaParams buildPartial() {
            EcdsaParams result2 = new EcdsaParams(this);
        ...
        private void buildPartial0(EcdsaParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.hashType_ = this.hashType_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.curve_ = this.curve_;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.encoding_ = this.encoding_;
            }
        }
