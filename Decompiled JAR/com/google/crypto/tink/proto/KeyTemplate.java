...
implements KeyTemplateOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", KeyTemplate.class.getName());
    ...
    implements KeyTemplateOrBuilder {
        ...
        public KeyTemplate build() {
            KeyTemplate result2 = this.buildPartial();
        ...
        public KeyTemplate buildPartial() {
            KeyTemplate result2 = new KeyTemplate(this);
        ...
        private void buildPartial0(KeyTemplate result2) {
