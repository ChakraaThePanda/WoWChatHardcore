...
public final class AesSivKeyManager {
    ...
    private static Map<String, Parameters> namedParameters() throws GeneralSecurityException {
        HashMap<String, AesSivParameters> result2 = new HashMap<String, AesSivParameters>();
        result2.put("AES256_SIV", PredefinedDeterministicAeadParameters.AES256_SIV);
        result2.put("AES256_SIV_RAW", AesSivParameters.builder().setKeySizeBytes(64).setVariant(AesSivParameters.Variant.NO_PREFIX).build());
