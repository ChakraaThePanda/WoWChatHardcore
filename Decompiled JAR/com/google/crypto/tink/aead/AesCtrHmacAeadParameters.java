...
extends AeadParameters {
    ...
    public int hashCode() {
        return Objects.hash(AesCtrHmacAeadParameters.class, this.aesKeySizeBytes, this.hmacKeySizeBytes, this.ivSizeBytes, this.tagSizeBytes, this.variant, this.hashType);
    }
