...
public final class ChaCha20Poly1305KeyManager {
    ...
    private static final MutableKeyCreationRegistry.KeyCreator<ChaCha20Poly1305Parameters> KEY_CREATOR = ChaCha20Poly1305KeyManager::createChaChaKey;
    ...
    private static Map<String, Parameters> namedParameters() throws GeneralSecurityException {
        HashMap<String, ChaCha20Poly1305Parameters> result2 = new HashMap<String, ChaCha20Poly1305Parameters>();
        result2.put("CHACHA20_POLY1305", ChaCha20Poly1305Parameters.create(ChaCha20Poly1305Parameters.Variant.TINK));
        result2.put("CHACHA20_POLY1305_RAW", ChaCha20Poly1305Parameters.create(ChaCha20Poly1305Parameters.Variant.NO_PREFIX));
