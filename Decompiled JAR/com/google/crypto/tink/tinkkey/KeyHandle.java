...
public class KeyHandle {
    ...
    public static KeyHandle createFromKey(TinkKey key, KeyAccess access) throws GeneralSecurityException {
        KeyHandle result2 = new KeyHandle(key);
        result2.checkAccess(access);
        return result2;
    }
    ...
    public static KeyHandle generateNew(KeyTemplate keyTemplate) throws GeneralSecurityException {
        ProtoKey protoKey = new ProtoKey(KeyHandle.newKeyData(keyTemplate), KeyTemplateProtoConverter.getOutputPrefixType(keyTemplate));
