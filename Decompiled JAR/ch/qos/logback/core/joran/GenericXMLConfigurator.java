...
extends ContextAwareBase {
    ...
    public final void doConfigure(InputStream inputStream2) throws JoranException {
        this.doConfigure(new InputSource(inputStream2));
    }

    public final void doConfigure(InputStream inputStream2, String systemId) throws JoranException {
