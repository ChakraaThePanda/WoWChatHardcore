...
KMappedMarker {
    ...
    public final Set<String> names() {
        TreeSet<String> result2 = new TreeSet<String>(StringsKt.getCASE_INSENSITIVE_ORDER(StringCompanionObject.INSTANCE));
        int n = this.size();
        for (int i = 0; i < n; ++i) {
    ...
    public final Map<String, List<String>> toMultimap() {
        TreeMap result2 = new TreeMap(StringsKt.getCASE_INSENSITIVE_ORDER(StringCompanionObject.INSTANCE));
        int n = this.size();
        for (int i = 0; i < n; ++i) {
            String name;
            ...
            List values2 = (List)result2.get(name);
            if (values2 == null) {
                values2 = new ArrayList(2);
                ((Map)result2).put(name, values2);
            }
