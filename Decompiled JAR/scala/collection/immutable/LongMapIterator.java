        ...
        block6: {
            ...
            while (true) {
                ...
                if (longMap instanceof LongMap.Bin) {
                    ...
                    if (t2 instanceof LongMap.Tip) {
                        LongMap.Tip tip = (LongMap.Tip)t2;
                        this.push(right);
                        t = this.valueOf(tip);
                        break block6;
                    }
            ...
            if (longMap instanceof LongMap.Tip) {
