        ...
        block6: {
            ...
            while (true) {
                ...
                if (intMap instanceof IntMap.Bin) {
                    ...
                    if (t2 instanceof IntMap.Tip) {
                        IntMap.Tip tip = (IntMap.Tip)t2;
                        this.push(right);
                        t = this.valueOf(tip);
                        break block6;
                    }
            ...
            if (intMap instanceof IntMap.Tip) {
