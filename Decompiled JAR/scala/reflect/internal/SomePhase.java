...
public final class SomePhase {
    ...
    public static boolean equals(Object object) {
        return SomePhase$.MODULE$.equals(object);
    }
    ...
    public static int compareTo(Object object) {
        return SomePhase$.MODULE$.compareTo(object);
    }

    public static boolean $greater$eq(Object object) {
        return SomePhase$.MODULE$.$greater$eq(object);
    }

    public static boolean $less$eq(Object object) {
        return SomePhase$.MODULE$.$less$eq(object);
    }

    public static boolean $greater(Object object) {
        return SomePhase$.MODULE$.$greater(object);
    }

    public static boolean $less(Object object) {
        return SomePhase$.MODULE$.$less(object);
    }
}
