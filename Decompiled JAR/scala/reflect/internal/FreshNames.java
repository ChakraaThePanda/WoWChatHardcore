...
public interface FreshNames {
    ...
    public static /* synthetic */ Names.TermName freshTermName$(FreshNames $this, String prefix, FreshNameCreator creator) {
        return $this.freshTermName(prefix, creator);
    }

    default public Names.TermName freshTermName(String prefix, FreshNameCreator creator) {
        return ((Names)((Object)this)).newTermName(creator.newName(prefix));
    }

    public static /* synthetic */ String freshTermName$default$1$(FreshNames $this) {
        return $this.freshTermName$default$1();
    }

    default public String freshTermName$default$1() {
        return ((StdNames)((Object)this)).nme().FRESH_TERM_NAME_PREFIX();
    }

    public static /* synthetic */ Names.TypeName freshTypeName$(FreshNames $this, String prefix, FreshNameCreator creator) {
        return $this.freshTypeName(prefix, creator);
    }

    default public Names.TypeName freshTypeName(String prefix, FreshNameCreator creator) {
    ...
    public class FreshNameExtractor {
        ...
        public Option<String> unapply(Names.Name name) {
            ...
            Option<List<String>> option2 = this.freshlyNamed().unapplySeq(string);
        ...
        public FreshNameExtractor(String creatorPrefix) {
            ...
            String string = new StringBuilder(8).append(pre).append("(.*?)\\d*").toString();
            if (Predef$.MODULE$ == null) {
                throw null;
            }
            this.freshlyNamed = new StringOps(string).r();
        }
    }
}
