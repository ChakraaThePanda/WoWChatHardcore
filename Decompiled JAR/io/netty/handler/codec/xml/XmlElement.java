...
public abstract class XmlElement {
    ...
    public int hashCode() {
        ...
        result2 = 31 * result2 + (this.namespace != null ? this.namespace.hashCode() : 0);
        result2 = 31 * result2 + (this.prefix != null ? this.prefix.hashCode() : 0);
        result2 = 31 * result2 + this.namespaces.hashCode();
        return result2;
    }
