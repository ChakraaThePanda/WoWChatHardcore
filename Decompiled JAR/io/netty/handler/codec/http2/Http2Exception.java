...
extends Exception {
    ...
    public static Http2Exception connectionError(Http2Error error, String fmt, Object ... args2) {
        return new Http2Exception(error, Http2Exception.formatErrorMessage(fmt, args2));
    }

    public static Http2Exception connectionError(Http2Error error, Throwable cause, String fmt, Object ... args2) {
        return new Http2Exception(error, Http2Exception.formatErrorMessage(fmt, args2), cause);
    }

    public static Http2Exception closedStreamError(Http2Error error, String fmt, Object ... args2) {
        return new ClosedStreamCreationException(error, Http2Exception.formatErrorMessage(fmt, args2));
    }

    public static Http2Exception streamError(int id, Http2Error error, String fmt, Object ... args2) {
        return 0 == id ? Http2Exception.connectionError(error, fmt, args2) : new StreamException(id, error, Http2Exception.formatErrorMessage(fmt, args2));
    }

    public static Http2Exception streamError(int id, Http2Error error, Throwable cause, String fmt, Object ... args2) {
        return 0 == id ? Http2Exception.connectionError(error, cause, fmt, args2) : new StreamException(id, error, Http2Exception.formatErrorMessage(fmt, args2), cause);
    }

    public static Http2Exception headerListSizeError(int id, Http2Error error, boolean onDecode, String fmt, Object ... args2) {
        return 0 == id ? Http2Exception.connectionError(error, fmt, args2) : new HeaderListSizeException(id, error, Http2Exception.formatErrorMessage(fmt, args2), onDecode);
    }

    private static String formatErrorMessage(String fmt, Object[] args2) {
        if (fmt == null) {
            if (args2 == null || args2.length == 0) {
                return "Unexpected error";
            }
            return "Unexpected error: " + Arrays.toString(args2);
        }
