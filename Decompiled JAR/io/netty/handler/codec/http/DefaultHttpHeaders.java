...
extends HttpHeaders {
    ...
    public HttpHeaders add(String name, Iterable<?> values2) {
        this.headers.addObject((CharSequence)name, values2);
        return this;
    }

    @Override
    public HttpHeaders add(CharSequence name, Iterable<?> values2) {
        this.headers.addObject(name, values2);
        return this;
    }
    ...
    public HttpHeaders set(String name, Iterable<?> values2) {
        this.headers.setObject((CharSequence)name, values2);
        return this;
    }

    @Override
    public HttpHeaders set(CharSequence name, Iterable<?> values2) {
        this.headers.setObject(name, values2);
        return this;
    }
