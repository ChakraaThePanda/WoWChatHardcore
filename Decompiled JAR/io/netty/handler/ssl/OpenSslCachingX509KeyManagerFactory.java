...
extends KeyManagerFactory {
    ...
    public OpenSslCachingX509KeyManagerFactory(KeyManagerFactory factory2) {
        this(factory2, 1024);
    }

    public OpenSslCachingX509KeyManagerFactory(final KeyManagerFactory factory2, int maxCachedEntries) {
        super(new KeyManagerFactorySpi(){
            ...
            protected void engineInit(KeyStore keyStore, char[] chars) throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
                factory2.init(keyStore, chars);
            }

            @Override
            protected void engineInit(ManagerFactoryParameters managerFactoryParameters) throws InvalidAlgorithmParameterException {
                factory2.init(managerFactoryParameters);
            }

            @Override
            protected KeyManager[] engineGetKeyManagers() {
                return factory2.getKeyManagers();
            }
        }, factory2.getProvider(), factory2.getAlgorithm());
