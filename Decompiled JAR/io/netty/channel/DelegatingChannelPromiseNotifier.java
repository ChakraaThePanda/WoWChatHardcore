...
ChannelFutureListener {
    ...
    public boolean await(long timeout2, TimeUnit unit) throws InterruptedException {
        return this.delegate.await(timeout2, unit);
    }
    ...
    public boolean awaitUninterruptibly(long timeout2, TimeUnit unit) {
        return this.delegate.awaitUninterruptibly(timeout2, unit);
    }
    ...
    @Override
    public Void get(long timeout2, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException {
        return (Void)this.delegate.get(timeout2, unit);
    }
