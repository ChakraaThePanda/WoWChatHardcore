...
extends AbstractEventExecutorGroup {
    ...
    protected MultithreadEventExecutorGroup(int nThreads, ThreadFactory threadFactory, Object ... args2) {
        this(nThreads, (Executor)(threadFactory == null ? null : new ThreadPerTaskExecutor(threadFactory)), args2);
    }

    protected MultithreadEventExecutorGroup(int nThreads, Executor executor, Object ... args2) {
        this(nThreads, executor, DefaultEventExecutorChooserFactory.INSTANCE, args2);
    }

    protected MultithreadEventExecutorGroup(int nThreads, Executor executor, EventExecutorChooserFactory chooserFactory, Object ... args2) {
        ...
        for (int i = 0; i < nThreads; ++i) {
            ...
            try {
                this.children[i] = this.newChild(executor, args2);
                success = true;
                continue;
            }
            catch (Exception e) {
