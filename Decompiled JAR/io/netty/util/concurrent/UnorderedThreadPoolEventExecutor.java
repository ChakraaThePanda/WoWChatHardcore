...
implements EventExecutor {
    ...
    protected <V> RunnableScheduledFuture<V> decorateTask(Runnable runnable2, RunnableScheduledFuture<V> task) {
        return runnable2 instanceof NonNotifyRunnable ? task : new RunnableScheduledFutureTask((EventExecutor)this, task, false);
    }
    ...
    ScheduledFuture<V> {
        ...
        V runTask() throws Throwable {
            Object result2 = super.runTask();
            if (result2 == null && this.wasCallable) {
