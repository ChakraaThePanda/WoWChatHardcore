    ...
    public static final Sequence<Integer> asSequence(@NotNull IntStream $this$asSequence) {
        ...
        return new Sequence<Integer>($this$asSequence){
            ...
            public Iterator<Integer> iterator() {
                boolean bl = false;
                PrimitiveIterator.OfInt ofInt2 = this.$this_asSequence$inlined.iterator();
    ...
    public static final Sequence<Long> asSequence(@NotNull LongStream $this$asSequence) {
        ...
        return new Sequence<Long>($this$asSequence){
            ...
            public Iterator<Long> iterator() {
                boolean bl = false;
                PrimitiveIterator.OfLong ofLong2 = this.$this_asSequence$inlined.iterator();
                Intrinsics.checkNotNullExpressionValue(ofLong2, "iterator()");
                return ofLong2;
            }
        };
    }
    ...
    public static final Sequence<Double> asSequence(@NotNull DoubleStream $this$asSequence) {
        ...
        return new Sequence<Double>($this$asSequence){
            ...
            public Iterator<Double> iterator() {
                boolean bl = false;
                PrimitiveIterator.OfDouble ofDouble2 = this.$this_asSequence$inlined.iterator();
                Intrinsics.checkNotNullExpressionValue(ofDouble2, "iterator()");
                return ofDouble2;
            }
        };
    }
