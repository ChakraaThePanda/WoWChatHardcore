...
extends ContextAwareBase {
    ...
    public void setProperty(String name, String value) {
        ...
        Method setter2 = this.findSetterMethod(name);
        if (setter2 == null) {
            this.addWarn("No setter for property [" + name + "] in " + this.objClass.getName() + ".");
        } else {
            try {
                this.setProperty(setter2, name, value);
            }
    ...
    private void setProperty(Method setter2, String name, String value) throws PropertySetterException {
        Object arg;
    ...
    public AggregationType computeAggregationType(String name) {
        ...
        if ((setter2 = this.findSetterMethod(name)) != null) {
            return this.computeRawAggregationType(setter2);
        }
        return AggregationType.NOT_FOUND;
    }
    ...
    public void setComplexProperty(String name, Object complexProperty) {
        ...
        Class<?>[] paramTypes = setter2.getParameterTypes();
        if (!this.isSanityCheckSuccessful(name, setter2, paramTypes, complexProperty)) {
            return;
        }
        try {
            this.invokeMethodWithSingleParameterOnThisObject(setter2, complexProperty);
        }
        catch (Exception e) {
