...
implements Comparable<Duration> {
    ...
    public static final long times-UwyO8pc(long arg0, int scale) {
        ...
        if (Duration.isInNanos-impl(arg0)) {
            ...
            l = result2 / (long)scale == value ? DurationKt.access$durationOfMillis(RangesKt.coerceIn(result2, new LongRange(-4611686018427387903L, 0x3FFFFFFFFFFFFFFFL))) : (MathKt.getSign(value) * MathKt.getSign(scale) > 0 ? INFINITE : NEG_INFINITE);
        }
        return l;
    }
    ...
    public static final long div-UwyO8pc(long arg0, int scale) {
        ...
        if (new LongRange(-4611686018426L, 4611686018426L).contains(result2)) {
