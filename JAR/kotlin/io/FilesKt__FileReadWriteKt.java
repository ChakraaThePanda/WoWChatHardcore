...
extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(@NotNull File $this$readBytes) {
        ...
        try {
            ...
            if (remaining > 0) {
                byte[] byArray3 = Arrays.copyOf(result2, offset);
                byArray2 = byArray3;
                ...
                if (extraByte == -1) {
                    ...
                    byte[] byArray5 = Arrays.copyOf(result2, resultingSize);
                    Intrinsics.checkNotNullExpressionValue(byArray5, "copyOf(this, newSize)");
                    byArray2 = ArraysKt.copyInto(byArray4, byArray5, result2.length, 0, extra.size());
                }
            }
            byArray = byArray2;
        }
