...
final class PlatformDependent0 {
    ...
    static boolean equals(byte[] bytes1, int startPos1, byte[] bytes2, int startPos2, int length) {
        ...
        if (length >= 8) {
            ...
            for (long i = baseOffset1 - 8L + (long)length; i >= end; i -= 8L) {
                if (UNSAFE.getLong((Object)bytes1, i) == UNSAFE.getLong((Object)bytes2, i + diff)) continue;
                return false;
            }
        }
    ...
    static int equalsConstantTime(byte[] bytes1, int startPos1, byte[] bytes2, int startPos2, int length) {
        ...
        long diff = startPos2 - startPos1;
        for (long i = baseOffset1 - 8L + (long)length; i >= end; i -= 8L) {
            result2 |= UNSAFE.getLong((Object)bytes1, i) ^ UNSAFE.getLong((Object)bytes2, i + diff);
        }
        if (remainingBytes >= 4L) {
            result2 |= (long)(UNSAFE.getInt((Object)bytes1, baseOffset1) ^ UNSAFE.getInt((Object)bytes2, baseOffset1 + diff));
            remainingBytes -= 4L;
        }
        if (remainingBytes >= 2L) {
            pos = end - remainingBytes;
            result2 |= (long)(UNSAFE.getChar((Object)bytes1, pos) ^ UNSAFE.getChar((Object)bytes2, pos + diff));
            remainingBytes -= 2L;
        }
        if (remainingBytes == 1L) {
            pos = end - 1L;
            result2 |= (long)(UNSAFE.getByte((Object)bytes1, pos) ^ UNSAFE.getByte((Object)bytes2, pos + diff));
        }
