...
implements Promise<V> {
    ...
    public boolean trySuccess(V result2) {
        return this.setSuccess0(result2);
    }
    ...
    private Throwable cause0(Object result2) {
        if (!(result2 instanceof CauseHolder)) {
            return null;
        }
        if (result2 == CANCELLATION_CAUSE_HOLDER) {
    ...
    public boolean await(long timeout2, TimeUnit unit) throws InterruptedException {
        return this.await0(unit.toNanos(timeout2), true);
    }
    ...
    public boolean awaitUninterruptibly(long timeout2, TimeUnit unit) {
        try {
            return this.await0(unit.toNanos(timeout2), false);
        }
        catch (InterruptedException e) {
    ...
    public V getNow() {
        Object result2 = this.result;
        if (result2 instanceof CauseHolder || result2 == SUCCESS || result2 == UNCANCELLABLE) {
            return null;
        }
        return (V)result2;
    }
    ...
    public V get() throws InterruptedException, ExecutionException {
        ...
        if (result2 == SUCCESS || result2 == UNCANCELLABLE) {
            return null;
        }
        Throwable cause = this.cause0(result2);
        if (cause == null) {
            return (V)result2;
        }
