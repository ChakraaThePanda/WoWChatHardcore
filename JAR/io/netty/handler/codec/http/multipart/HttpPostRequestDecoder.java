...
implements InterfaceHttpPostRequestDecoder {
    ...
    public HttpPostRequestDecoder(HttpDataFactory factory2, HttpRequest request) {
        this(factory2, request, HttpConstants.DEFAULT_CHARSET);
    }

    public HttpPostRequestDecoder(HttpDataFactory factory2, HttpRequest request, Charset charset) {
        ObjectUtil.checkNotNull(factory2, "factory");
        ObjectUtil.checkNotNull(request, "request");
        ObjectUtil.checkNotNull(charset, "charset");
        this.decoder = HttpPostRequestDecoder.isMultipart(request) ? new HttpPostMultipartRequestDecoder(factory2, request, charset) : new HttpPostStandardRequestDecoder(factory2, request, charset);
    }
