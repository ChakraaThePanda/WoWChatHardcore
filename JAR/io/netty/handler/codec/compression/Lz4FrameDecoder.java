...
extends ByteToMessageDecoder {
    ...
    public Lz4FrameDecoder(LZ4Factory factory2, boolean validateChecksums) {
        this(factory2, validateChecksums ? new Lz4XXHash32(-1756908916) : null);
    }

    public Lz4FrameDecoder(LZ4Factory factory2, Checksum checksum) {
        this.decompressor = ObjectUtil.checkNotNull(factory2, "factory").fastDecompressor();
