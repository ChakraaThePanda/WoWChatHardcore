...
public class XmlDocumentStart {
    ...
    public int hashCode() {
        int result2 = this.encoding != null ? this.encoding.hashCode() : 0;
        result2 = 31 * result2 + (this.version != null ? this.version.hashCode() : 0);
        result2 = 31 * result2 + (this.standalone ? 1 : 0);
        result2 = 31 * result2 + (this.encodingScheme != null ? this.encodingScheme.hashCode() : 0);
        return result2;
    }
