...
implements BidiMap<K, V> {
    ...
    protected Iterator<K> createKeySetIterator(Iterator<K> iterator2) {
        return new KeySetIterator<K>(iterator2, this);
    }
    ...
    protected Iterator<V> createValuesIterator(Iterator<V> iterator2) {
        return new ValuesIterator<V>(iterator2, this);
    }
    ...
    protected Iterator<Map.Entry<K, V>> createEntrySetIterator(Iterator<Map.Entry<K, V>> iterator2) {
        return new EntrySetIterator<K, V>(iterator2, this);
    }
    ...
    extends AbstractIteratorDecorator<Map.Entry<K, V>> {
        ...
        protected EntrySetIterator(Iterator<Map.Entry<K, V>> iterator2, AbstractDualBidiMap<K, V> parent) {
            super(iterator2);
            this.parent = parent;
        }
    ...
    extends AbstractIteratorDecorator<V> {
        ...
        protected ValuesIterator(Iterator<V> iterator2, AbstractDualBidiMap<?, V> parent) {
            super(iterator2);
            this.parent = parent;
        }
    ...
    extends AbstractIteratorDecorator<K> {
        ...
        protected KeySetIterator(Iterator<K> iterator2, AbstractDualBidiMap<K, ?> parent) {
            super(iterator2);
            this.parent = parent;
        }
