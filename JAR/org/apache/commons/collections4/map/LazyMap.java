...
implements Serializable {
    ...
    public static <K, V> LazyMap<K, V> lazyMap(Map<K, V> map, Factory<? extends V> factory2) {
        return new LazyMap<K, V>(map, factory2);
    }

    public static <V, K> LazyMap<K, V> lazyMap(Map<K, V> map, Transformer<? super K, ? extends V> factory2) {
        return new LazyMap<K, V>(map, factory2);
    }
    ...
    protected LazyMap(Map<K, V> map, Transformer<? super K, ? extends V> factory2) {
        super(map);
        if (factory2 == null) {
            throw new NullPointerException("Factory must not be null");
        }
