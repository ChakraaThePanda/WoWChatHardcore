...
public final class HttpUrl {
    ...
    public final List<String> queryParameterValues(@NotNull String name) {
        ...
        if (n2 > 0 && i <= n || n2 < 0 && n <= i) {
            while (true) {
                if (Intrinsics.areEqual(name, this.queryNamesAndValues.get(i))) {
                    result2.add(this.queryNamesAndValues.get(i + 1));
                }
                if (i == n) break;
                i += n2;
            }
    ...
    public static final class Builder {
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            for (int i = 0; i < n; ++i) {
                $this$reencodeForUri_u24lambda_u2428.encodedPathSegments.set(i, okhttp3.HttpUrl$Companion.canonicalize$okhttp$default(Companion, $this$reencodeForUri_u24lambda_u2428.encodedPathSegments.get(i), 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, true, true, false, false, null, 227, null));
            }
        ...
        public final HttpUrl build() {
            ...
            if (list != null) {
                ...
                for (Object item$iv$iv : $this$mapTo$iv$iv2) {
                    ...
                    boolean bl2 = false;
                    void v9 = it;
                    collection4.add(v9 != null ? okhttp3.HttpUrl$Companion.percentDecode$okhttp$default(Companion, (String)v9, 0, 0, true, 3, null) : null);
                }
