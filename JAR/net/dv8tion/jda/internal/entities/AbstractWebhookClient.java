...
implements WebhookClient<T> {
    ...
    @Override
    @Nonnull
    public WebhookMessageCreateAction<T> sendFiles(@Nonnull Collection<? extends FileUpload> files2) {
        return (WebhookMessageCreateAction)this.sendRequest().addFiles(files2);
    }
