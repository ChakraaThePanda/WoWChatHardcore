...
implements SerializableData {
        ...
        synchronized (object) {
            ...
            if (!this.fields.isEmpty()) {
                ...
                for (Field field2 : this.fields) {
                    fieldsArray.add(DataObject.empty().put("name", field2.getName()).put("value", field2.getValue()).put("inline", field2.isInline()));
                }
    ...
    public static class Field {
        ...
        public Field(String name, String value, boolean inline2, boolean checked) {
            if (checked) {
        ...
        public Field(String name, String value, boolean inline2) {
            this(name, value, inline2, true);
        }
        ...
        public boolean equals(Object obj) {
            ...
            return field2 == this || field2.inline == this.inline && Objects.equals(field2.name, this.name) && Objects.equals(field2.value, this.value);
        }
    }
}
