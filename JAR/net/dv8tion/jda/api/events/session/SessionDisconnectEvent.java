...
extends GenericSessionEvent {
    ...
    public SessionDisconnectEvent(@Nonnull JDA api2, @Nullable WebSocketFrame serverCloseFrame, @Nullable WebSocketFrame clientCloseFrame, boolean closedByServer, @Nonnull OffsetDateTime disconnectTime) {
        super(api2, SessionState.DISCONNECTED);
