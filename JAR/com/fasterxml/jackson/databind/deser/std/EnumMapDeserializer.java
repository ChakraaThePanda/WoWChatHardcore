...
ResolvableDeserializer {
    ...
    @Override
    public EnumMap<?, ?> deserialize(JsonParser p, DeserializationContext ctxt, EnumMap result2) throws IOException {
        String keyStr;
                ...
                if (key == null) {
                    ...
                    block12: {
                        try {
                            ...
                            return (EnumMap)this.wrapAndThrow(ctxt, e, result2, keyStr);
                        }
                    }
            ...
            block14: {
                ...
                if (prop != null) {
                    if (buffer.assignParameter(prop, prop.deserialize(p, ctxt))) {
                        ...
                        p.nextToken();
                        try {
                            result2 = (EnumMap)creator.build(ctxt, buffer);
                        }
                        catch (Exception e) {
