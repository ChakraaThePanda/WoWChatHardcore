...
implements ContextualDeserializer {
    ...
    public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        Object[] result2 = this._untyped ? buffer.completeAndClearBuffer(chunk, ix) : buffer.completeAndClearBuffer(chunk, ix, this._elementClass);
    ...
    public Object deserialize(JsonParser p, DeserializationContext ctxt, Object intoValue0) throws IOException {
        ...
        Object[] result3 = this._untyped ? buffer.completeAndClearBuffer(chunk, ix) : buffer.completeAndClearBuffer(chunk, ix, this._elementClass);
        ctxt.returnObjectBuffer(buffer);
        return result3;
    }
    ...
    protected Byte[] deserializeFromBase64(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        Byte[] result2 = new Byte[b.length];
        int len = b.length;
        for (int i = 0; i < len; ++i) {
            result2[i] = b[i];
        }
    ...
    protected Object handleNonArray(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        Object[] result2 = this._untyped ? new Object[1] : (Object[])Array.newInstance(this._elementClass, 1);
        result2[0] = value;
        return result2;
    }
}
