...
public abstract class StdKeySerializers {
    ...
    extends StdSerializer<Object> {
        ...
        protected EnumKeySerializer(Class<?> enumType, EnumValues values2, EnumValues valuesByEnumNaming) {
            super(enumType, false);
            this._values = values2;
    ...
    extends StdSerializer<Object> {
        ...
        protected JsonSerializer<Object> _findAndAddDynamic(PropertySerializerMap map, Class<?> type, SerializerProvider provider) throws JsonMappingException {
            ...
            PropertySerializerMap.SerializerAndMapResult result2 = map.findAndAddKeySerializer(type, provider, null);
            if (map != result2.map) {
