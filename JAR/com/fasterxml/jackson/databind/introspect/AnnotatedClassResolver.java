...
public class AnnotatedClassResolver {
    ...
    private static void _addSuperTypes(JavaType type, List<JavaType> result2, boolean addClassItself) {
    ...
    private static void _addSuperInterfaces(JavaType type, List<JavaType> result2, boolean addClassItself) {
        Class<?> cls = type.getRawClass();
        if (addClassItself) {
            if (AnnotatedClassResolver._contains(result2, cls)) {
                return;
