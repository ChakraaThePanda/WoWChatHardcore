...
implements Comparable<POJOPropertyBuilder> {
    ...
    public AnnotatedField getField() {
        ...
        AnnotatedField field2 = (AnnotatedField)this._fields.value;
            ...
            block10: {
                ...
                block8: {
                    ...
                    block9: {
                        ...
                        fieldClass = field2.getDeclaringClass();
                ...
                if ((currStatic = field2.isStatic()) != (nextStatic = nextField.isStatic())) {
                    if (currStatic) {
                        field2 = nextField;
                    }
                } else {
                    throw new IllegalArgumentException("Multiple fields representing property \"" + this.getName() + "\": " + field2.getFullName() + " vs " + nextField.getFullName());
                }
            }
            next = next.next;
        }
    ...
    public AnnotationIntrospector.ReferenceProperty findReferenceType() {
        AnnotationIntrospector.ReferenceProperty result2 = this._referenceInfo;
        if (result2 != null) {
            if (result2 == NOT_REFEFERENCE_PROP) {
                return null;
            }
            return result2;
        }
        result2 = this.fromMemberAnnotations(new WithMember<AnnotationIntrospector.ReferenceProperty>(){
    ...
    public Set<PropertyName> findExplicitNames() {
        ...
        return (renamed = this._findExplicitNames(this._ctorParameters, renamed)) == null ? Collections.emptySet() : renamed;
    }
    ...
    private boolean _hasExplicitName(Linked<? extends AnnotatedMember> node, PropertyName nameToMatch) {
        while (node != null) {
    ...
    protected <T> T fromMemberAnnotations(WithMember<T> func) {
        ...
        if (this._annotationIntrospector != null) {
            if (this._forSerialization) {
                if (this._getters != null) {
                    result2 = func.withMember((AnnotatedMember)this._getters.value);
                }
            } else {
                if (this._ctorParameters != null) {
                    result2 = func.withMember((AnnotatedMember)this._ctorParameters.value);
                }
                if (result2 == null && this._setters != null) {
                    result2 = func.withMember((AnnotatedMember)this._setters.value);
                }
            }
            if (result2 == null && this._fields != null) {
                result2 = func.withMember((AnnotatedMember)this._fields.value);
            }
        }
        return result2;
    }
    ...
    protected <T> T fromMemberAnnotationsExcept(WithMember<T> func, T defaultValue) {
        ...
        if (this._forSerialization) {
            T result3;
            if (this._getters != null && (result3 = func.withMember((AnnotatedMember)this._getters.value)) != null && result3 != defaultValue) {
                return result3;
            }
            if (this._fields != null && (result3 = func.withMember((AnnotatedMember)this._fields.value)) != null && result3 != defaultValue) {
                return result3;
            }
            if (this._ctorParameters != null && (result3 = func.withMember((AnnotatedMember)this._ctorParameters.value)) != null && result3 != defaultValue) {
                return result3;
            }
            if (this._setters != null && (result3 = func.withMember((AnnotatedMember)this._setters.value)) != null && result3 != defaultValue) {
                return result3;
            }
            return null;
        }
    ...
    implements Iterator<T> {
        ...
        public T next() {
            ...
            AnnotatedMember result2 = (AnnotatedMember)this.next.value;
