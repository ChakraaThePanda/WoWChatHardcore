...
import com.fasterxml.jackson.core.internal.shaded.fdp.v2_18_3.ParseDigitsTaskCharArray;
...
extends AbstractBigIntegerParser {
    ...
    private BigInteger parseHexDigits(char[] str, int from, int to, boolean isNegative) {
        ...
        return isNegative ? result2.negate() : result2;
    }
    ...
    private BigInteger parseManyDecDigits(char[] str, int from, int to, boolean isNegative) {
        ...
        BigInteger result2 = ParseDigitsTaskCharArray.parseDigitsRecursive(str, from, to, powersOfTen, 400);
        return isNegative ? result2.negate() : result2;
    }
