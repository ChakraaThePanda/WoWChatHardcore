...
implements RsaSsaPssPublicKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPssPublicKey.class.getName());
    ...
    implements RsaSsaPssPublicKeyOrBuilder {
        ...
        public RsaSsaPssPublicKey build() {
            RsaSsaPssPublicKey result2 = this.buildPartial();
        ...
        public RsaSsaPssPublicKey buildPartial() {
            RsaSsaPssPublicKey result2 = new RsaSsaPssPublicKey(this);
        ...
        private void buildPartial0(RsaSsaPssPublicKey result2) {
