...
implements PrfBasedDeriverKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", PrfBasedDeriverKey.class.getName());
    ...
    implements PrfBasedDeriverKeyOrBuilder {
        ...
        public PrfBasedDeriverKey build() {
            PrfBasedDeriverKey result2 = this.buildPartial();
        ...
        public PrfBasedDeriverKey buildPartial() {
            PrfBasedDeriverKey result2 = new PrfBasedDeriverKey(this);
        ...
        private void buildPartial0(PrfBasedDeriverKey result2) {
            ...
            if ((from_bitField0_ & 2) != 0) {
                result2.prfKey_ = this.prfKeyBuilder_ == null ? this.prfKey_ : this.prfKeyBuilder_.build();
                to_bitField0_ |= 1;
            }
        ...
        public KeyData.Builder getPrfKeyBuilder() {
            this.bitField0_ |= 2;
            this.onChanged();
            return this.getPrfKeyFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<KeyData, KeyData.Builder, KeyDataOrBuilder> getPrfKeyFieldBuilder() {
            if (this.prfKeyBuilder_ == null) {
