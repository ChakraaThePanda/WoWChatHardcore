...
implements AesEaxKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesEaxKeyFormat.class.getName());
    ...
    implements AesEaxKeyFormatOrBuilder {
        ...
        public AesEaxKeyFormat build() {
            AesEaxKeyFormat result2 = this.buildPartial();
        ...
        public AesEaxKeyFormat buildPartial() {
            AesEaxKeyFormat result2 = new AesEaxKeyFormat(this);
        ...
        private void buildPartial0(AesEaxKeyFormat result2) {
        ...
        private SingleFieldBuilder<AesEaxParams, AesEaxParams.Builder, AesEaxParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
