...
implements EciesHkdfKemParamsOrBuilder {
    ...
    public EllipticCurveType getCurveType() {
        EllipticCurveType result2 = EllipticCurveType.forNumber(this.curveType_);
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EciesHkdfKemParams.class.getName());
    ...
    implements EciesHkdfKemParamsOrBuilder {
        ...
        public EciesHkdfKemParams build() {
            EciesHkdfKemParams result2 = this.buildPartial();
        ...
        public EciesHkdfKemParams buildPartial() {
            EciesHkdfKemParams result2 = new EciesHkdfKemParams(this);
        ...
        private void buildPartial0(EciesHkdfKemParams result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.curveType_ = this.curveType_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.hkdfHashType_ = this.hkdfHashType_;
            }
            if ((from_bitField0_ & 4) != 0) {
                result2.hkdfSalt_ = this.hkdfSalt_;
            }
        }
