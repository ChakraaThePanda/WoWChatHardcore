...
implements AesCtrParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCtrParams.class.getName());
    ...
    implements AesCtrParamsOrBuilder {
        ...
        public AesCtrParams build() {
            AesCtrParams result2 = this.buildPartial();
        ...
        public AesCtrParams buildPartial() {
            AesCtrParams result2 = new AesCtrParams(this);
        ...
        private void buildPartial0(AesCtrParams result2) {
