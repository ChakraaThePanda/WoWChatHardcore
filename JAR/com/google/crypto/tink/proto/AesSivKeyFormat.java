...
implements AesSivKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesSivKeyFormat.class.getName());
    ...
    implements AesSivKeyFormatOrBuilder {
        ...
        public AesSivKeyFormat build() {
            AesSivKeyFormat result2 = this.buildPartial();
        ...
        public AesSivKeyFormat buildPartial() {
            AesSivKeyFormat result2 = new AesSivKeyFormat(this);
        ...
        private void buildPartial0(AesSivKeyFormat result2) {
