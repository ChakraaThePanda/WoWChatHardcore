...
implements JwtRsaSsaPkcs1PublicKeyOrBuilder {
    ...
    public JwtRsaSsaPkcs1Algorithm getAlgorithm() {
        JwtRsaSsaPkcs1Algorithm result2 = JwtRsaSsaPkcs1Algorithm.forNumber(this.algorithm_);
        return result2 == null ? JwtRsaSsaPkcs1Algorithm.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtRsaSsaPkcs1PublicKey.class.getName());
    ...
    implements JwtRsaSsaPkcs1PublicKeyOrBuilder {
        ...
        public JwtRsaSsaPkcs1PublicKey build() {
            JwtRsaSsaPkcs1PublicKey result2 = this.buildPartial();
        ...
        public JwtRsaSsaPkcs1PublicKey buildPartial() {
            JwtRsaSsaPkcs1PublicKey result2 = new JwtRsaSsaPkcs1PublicKey(this);
        ...
        private void buildPartial0(JwtRsaSsaPkcs1PublicKey result2) {
            int from_bitField0_ = this.bitField0_;
            if ((from_bitField0_ & 1) != 0) {
                result2.version_ = this.version_;
            }
            if ((from_bitField0_ & 2) != 0) {
                result2.algorithm_ = this.algorithm_;
            }
            ...
            if ((from_bitField0_ & 0x10) != 0) {
                result2.customKid_ = this.customKidBuilder_ == null ? this.customKid_ : this.customKidBuilder_.build();
                to_bitField0_ |= 1;
            }
        ...
        public CustomKid.Builder getCustomKidBuilder() {
            this.bitField0_ |= 0x10;
            this.onChanged();
            return this.getCustomKidFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<CustomKid, CustomKid.Builder, CustomKidOrBuilder> getCustomKidFieldBuilder() {
            if (this.customKidBuilder_ == null) {
    ...
    implements CustomKidOrBuilder {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", CustomKid.class.getName());
        ...
        implements CustomKidOrBuilder {
            ...
            public CustomKid build() {
                CustomKid result2 = this.buildPartial();
                if (!result2.isInitialized()) {
                    throw Builder.newUninitializedMessageException(result2);
                }
                return result2;
            ...
            public CustomKid buildPartial() {
                CustomKid result2 = new CustomKid(this);
                if (this.bitField0_ != 0) {
                    this.buildPartial0(result2);
                }
                this.onBuilt();
            ...
            private void buildPartial0(CustomKid result2) {
                int from_bitField0_ = this.bitField0_;
                if ((from_bitField0_ & 1) != 0) {
