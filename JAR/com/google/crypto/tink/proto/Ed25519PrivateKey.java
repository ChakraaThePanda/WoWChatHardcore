...
implements Ed25519PrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Ed25519PrivateKey.class.getName());
    ...
    implements Ed25519PrivateKeyOrBuilder {
        ...
        public Ed25519PrivateKey build() {
            Ed25519PrivateKey result2 = this.buildPartial();
        ...
        public Ed25519PrivateKey buildPartial() {
            Ed25519PrivateKey result2 = new Ed25519PrivateKey(this);
        ...
        private void buildPartial0(Ed25519PrivateKey result2) {
        ...
        private SingleFieldBuilder<Ed25519PublicKey, Ed25519PublicKey.Builder, Ed25519PublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
