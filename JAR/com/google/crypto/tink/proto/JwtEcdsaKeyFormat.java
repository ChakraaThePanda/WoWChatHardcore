...
implements JwtEcdsaKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtEcdsaKeyFormat.class.getName());
    ...
    implements JwtEcdsaKeyFormatOrBuilder {
        ...
        public JwtEcdsaKeyFormat build() {
            JwtEcdsaKeyFormat result2 = this.buildPartial();
        ...
        public JwtEcdsaKeyFormat buildPartial() {
            JwtEcdsaKeyFormat result2 = new JwtEcdsaKeyFormat(this);
        ...
        private void buildPartial0(JwtEcdsaKeyFormat result2) {
