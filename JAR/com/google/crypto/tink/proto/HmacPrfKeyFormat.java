...
implements HmacPrfKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacPrfKeyFormat.class.getName());
    ...
    implements HmacPrfKeyFormatOrBuilder {
        ...
        public HmacPrfKeyFormat build() {
            HmacPrfKeyFormat result2 = this.buildPartial();
        ...
        public HmacPrfKeyFormat buildPartial() {
            HmacPrfKeyFormat result2 = new HmacPrfKeyFormat(this);
        ...
        private void buildPartial0(HmacPrfKeyFormat result2) {
        ...
        private SingleFieldBuilder<HmacPrfParams, HmacPrfParams.Builder, HmacPrfParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
