...
implements EciesAeadHkdfKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EciesAeadHkdfKeyFormat.class.getName());
    ...
    implements EciesAeadHkdfKeyFormatOrBuilder {
        ...
        public EciesAeadHkdfKeyFormat build() {
            EciesAeadHkdfKeyFormat result2 = this.buildPartial();
        ...
        public EciesAeadHkdfKeyFormat buildPartial() {
            EciesAeadHkdfKeyFormat result2 = new EciesAeadHkdfKeyFormat(this);
        ...
        private void buildPartial0(EciesAeadHkdfKeyFormat result2) {
        ...
        private SingleFieldBuilder<EciesAeadHkdfParams, EciesAeadHkdfParams.Builder, EciesAeadHkdfParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
