...
implements JwtEcdsaPublicKeyOrBuilder {
    ...
    public JwtEcdsaAlgorithm getAlgorithm() {
        JwtEcdsaAlgorithm result2 = JwtEcdsaAlgorithm.forNumber(this.algorithm_);
        return result2 == null ? JwtEcdsaAlgorithm.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtEcdsaPublicKey.class.getName());
    ...
    implements JwtEcdsaPublicKeyOrBuilder {
        ...
        public JwtEcdsaPublicKey build() {
            JwtEcdsaPublicKey result2 = this.buildPartial();
        ...
        public JwtEcdsaPublicKey buildPartial() {
            JwtEcdsaPublicKey result2 = new JwtEcdsaPublicKey(this);
        ...
        private void buildPartial0(JwtEcdsaPublicKey result2) {
