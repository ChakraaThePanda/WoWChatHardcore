...
implements Ed25519PublicKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Ed25519PublicKey.class.getName());
    ...
    implements Ed25519PublicKeyOrBuilder {
        ...
        public Ed25519PublicKey build() {
            Ed25519PublicKey result2 = this.buildPartial();
        ...
        public Ed25519PublicKey buildPartial() {
            Ed25519PublicKey result2 = new Ed25519PublicKey(this);
        ...
        private void buildPartial0(Ed25519PublicKey result2) {
