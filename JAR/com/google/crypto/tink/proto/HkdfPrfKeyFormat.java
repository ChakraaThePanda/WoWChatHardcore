...
implements HkdfPrfKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HkdfPrfKeyFormat.class.getName());
    ...
    implements HkdfPrfKeyFormatOrBuilder {
        ...
        public HkdfPrfKeyFormat build() {
            HkdfPrfKeyFormat result2 = this.buildPartial();
        ...
        public HkdfPrfKeyFormat buildPartial() {
            HkdfPrfKeyFormat result2 = new HkdfPrfKeyFormat(this);
        ...
        private void buildPartial0(HkdfPrfKeyFormat result2) {
        ...
        private SingleFieldBuilder<HkdfPrfParams, HkdfPrfParams.Builder, HkdfPrfParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
