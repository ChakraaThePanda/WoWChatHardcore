...
implements JwtRsaSsaPkcs1KeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtRsaSsaPkcs1KeyFormat.class.getName());
    ...
    implements JwtRsaSsaPkcs1KeyFormatOrBuilder {
        ...
        public JwtRsaSsaPkcs1KeyFormat build() {
            JwtRsaSsaPkcs1KeyFormat result2 = this.buildPartial();
        ...
        public JwtRsaSsaPkcs1KeyFormat buildPartial() {
            JwtRsaSsaPkcs1KeyFormat result2 = new JwtRsaSsaPkcs1KeyFormat(this);
        ...
        private void buildPartial0(JwtRsaSsaPkcs1KeyFormat result2) {
