...
implements RsaSsaPssPrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPssPrivateKey.class.getName());
    ...
    implements RsaSsaPssPrivateKeyOrBuilder {
        ...
        public RsaSsaPssPrivateKey build() {
            RsaSsaPssPrivateKey result2 = this.buildPartial();
        ...
        public RsaSsaPssPrivateKey buildPartial() {
            RsaSsaPssPrivateKey result2 = new RsaSsaPssPrivateKey(this);
        ...
        private void buildPartial0(RsaSsaPssPrivateKey result2) {
        ...
        private SingleFieldBuilder<RsaSsaPssPublicKey, RsaSsaPssPublicKey.Builder, RsaSsaPssPublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
