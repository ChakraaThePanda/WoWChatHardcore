...
implements XAesGcmKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", XAesGcmKey.class.getName());
    ...
    implements XAesGcmKeyOrBuilder {
        ...
        public XAesGcmKey build() {
            XAesGcmKey result2 = this.buildPartial();
        ...
        public XAesGcmKey buildPartial() {
            XAesGcmKey result2 = new XAesGcmKey(this);
        ...
        private void buildPartial0(XAesGcmKey result2) {
        ...
        private SingleFieldBuilder<XAesGcmParams, XAesGcmParams.Builder, XAesGcmParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
