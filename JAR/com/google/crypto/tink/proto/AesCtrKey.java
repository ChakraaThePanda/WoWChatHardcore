...
implements AesCtrKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCtrKey.class.getName());
    ...
    implements AesCtrKeyOrBuilder {
        ...
        public AesCtrKey build() {
            AesCtrKey result2 = this.buildPartial();
        ...
        public AesCtrKey buildPartial() {
            AesCtrKey result2 = new AesCtrKey(this);
        ...
        private void buildPartial0(AesCtrKey result2) {
