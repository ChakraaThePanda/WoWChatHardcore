...
implements JwtEcdsaPrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtEcdsaPrivateKey.class.getName());
    ...
    implements JwtEcdsaPrivateKeyOrBuilder {
        ...
        public JwtEcdsaPrivateKey build() {
            JwtEcdsaPrivateKey result2 = this.buildPartial();
        ...
        public JwtEcdsaPrivateKey buildPartial() {
            JwtEcdsaPrivateKey result2 = new JwtEcdsaPrivateKey(this);
        ...
        private void buildPartial0(JwtEcdsaPrivateKey result2) {
        ...
        private SingleFieldBuilder<JwtEcdsaPublicKey, JwtEcdsaPublicKey.Builder, JwtEcdsaPublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
