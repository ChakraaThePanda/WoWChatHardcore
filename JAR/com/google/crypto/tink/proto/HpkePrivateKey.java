...
implements HpkePrivateKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", HpkePrivateKey.class.getName());
    ...
    implements HpkePrivateKeyOrBuilder {
        ...
        public HpkePrivateKey build() {
            HpkePrivateKey result2 = this.buildPartial();
        ...
        public HpkePrivateKey buildPartial() {
            HpkePrivateKey result2 = new HpkePrivateKey(this);
        ...
        private void buildPartial0(HpkePrivateKey result2) {
            ...
            if ((from_bitField0_ & 4) != 0) {
                result2.privateKey_ = this.privateKey_;
            }
        ...
        private SingleFieldBuilder<HpkePublicKey, HpkePublicKey.Builder, HpkePublicKeyOrBuilder> getPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
