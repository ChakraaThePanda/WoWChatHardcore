...
implements AesCtrHmacStreamingKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCtrHmacStreamingKeyFormat.class.getName());
    ...
    implements AesCtrHmacStreamingKeyFormatOrBuilder {
        ...
        public AesCtrHmacStreamingKeyFormat build() {
            AesCtrHmacStreamingKeyFormat result2 = this.buildPartial();
        ...
        public AesCtrHmacStreamingKeyFormat buildPartial() {
            AesCtrHmacStreamingKeyFormat result2 = new AesCtrHmacStreamingKeyFormat(this);
        ...
        private void buildPartial0(AesCtrHmacStreamingKeyFormat result2) {
            ...
            if ((from_bitField0_ & 4) != 0) {
                result2.keySize_ = this.keySize_;
            }
        ...
        private SingleFieldBuilder<AesCtrHmacStreamingParams, AesCtrHmacStreamingParams.Builder, AesCtrHmacStreamingParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
