...
implements JwtHmacKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtHmacKeyFormat.class.getName());
    ...
    implements JwtHmacKeyFormatOrBuilder {
        ...
        public JwtHmacKeyFormat build() {
            JwtHmacKeyFormat result2 = this.buildPartial();
        ...
        public JwtHmacKeyFormat buildPartial() {
            JwtHmacKeyFormat result2 = new JwtHmacKeyFormat(this);
        ...
        private void buildPartial0(JwtHmacKeyFormat result2) {
