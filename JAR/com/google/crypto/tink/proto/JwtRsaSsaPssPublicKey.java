...
implements JwtRsaSsaPssPublicKeyOrBuilder {
    ...
    public JwtRsaSsaPssAlgorithm getAlgorithm() {
        JwtRsaSsaPssAlgorithm result2 = JwtRsaSsaPssAlgorithm.forNumber(this.algorithm_);
        return result2 == null ? JwtRsaSsaPssAlgorithm.UNRECOGNIZED : result2;
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtRsaSsaPssPublicKey.class.getName());
    ...
    implements JwtRsaSsaPssPublicKeyOrBuilder {
        ...
        public JwtRsaSsaPssPublicKey build() {
            JwtRsaSsaPssPublicKey result2 = this.buildPartial();
        ...
        public JwtRsaSsaPssPublicKey buildPartial() {
            JwtRsaSsaPssPublicKey result2 = new JwtRsaSsaPssPublicKey(this);
        ...
        private void buildPartial0(JwtRsaSsaPssPublicKey result2) {
