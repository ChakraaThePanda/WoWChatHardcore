...
implements RsaSsaPkcs1PublicKeyOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPkcs1PublicKey.class.getName());
    ...
    implements RsaSsaPkcs1PublicKeyOrBuilder {
        ...
        public RsaSsaPkcs1PublicKey build() {
            RsaSsaPkcs1PublicKey result2 = this.buildPartial();
        ...
        public RsaSsaPkcs1PublicKey buildPartial() {
            RsaSsaPkcs1PublicKey result2 = new RsaSsaPkcs1PublicKey(this);
        ...
        private void buildPartial0(RsaSsaPkcs1PublicKey result2) {
