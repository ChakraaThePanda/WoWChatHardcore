...
implements PrfBasedDeriverParamsOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", PrfBasedDeriverParams.class.getName());
    ...
    implements PrfBasedDeriverParamsOrBuilder {
        ...
        public PrfBasedDeriverParams build() {
            PrfBasedDeriverParams result2 = this.buildPartial();
        ...
        public PrfBasedDeriverParams buildPartial() {
            PrfBasedDeriverParams result2 = new PrfBasedDeriverParams(this);
        ...
        private void buildPartial0(PrfBasedDeriverParams result2) {
            int from_bitField0_ = this.bitField0_;
            int to_bitField0_ = 0;
            if ((from_bitField0_ & 1) != 0) {
                result2.derivedKeyTemplate_ = this.derivedKeyTemplateBuilder_ == null ? this.derivedKeyTemplate_ : this.derivedKeyTemplateBuilder_.build();
                to_bitField0_ |= 1;
            }
        ...
        public KeyTemplate.Builder getDerivedKeyTemplateBuilder() {
            this.bitField0_ |= 1;
            this.onChanged();
            return this.getDerivedKeyTemplateFieldBuilder().getBuilder();
        }
        ...
        private SingleFieldBuilder<KeyTemplate, KeyTemplate.Builder, KeyTemplateOrBuilder> getDerivedKeyTemplateFieldBuilder() {
            if (this.derivedKeyTemplateBuilder_ == null) {
