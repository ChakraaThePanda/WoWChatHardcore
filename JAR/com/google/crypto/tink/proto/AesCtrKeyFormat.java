...
implements AesCtrKeyFormatOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCtrKeyFormat.class.getName());
    ...
    implements AesCtrKeyFormatOrBuilder {
        ...
        public AesCtrKeyFormat build() {
            AesCtrKeyFormat result2 = this.buildPartial();
        ...
        public AesCtrKeyFormat buildPartial() {
            AesCtrKeyFormat result2 = new AesCtrKeyFormat(this);
        ...
        private void buildPartial0(AesCtrKeyFormat result2) {
        ...
        private SingleFieldBuilder<AesCtrParams, AesCtrParams.Builder, AesCtrParamsOrBuilder> getParamsFieldBuilder() {
            if (this.paramsBuilder_ == null) {
