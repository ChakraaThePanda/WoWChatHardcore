...
implements OptionOrBuilder {
    ...
    implements OptionOrBuilder {
        ...
        private void buildPartial0(Option result2) {
            ...
            if ((from_bitField0_ & 2) != 0) {
                result2.value_ = this.valueBuilder_ == null ? this.value_ : this.valueBuilder_.build();
                to_bitField0_ |= 1;
            }
            ...
            try {
                ...
                block10: while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 18: {
                            input.readMessage(this.getValueFieldBuilder().getBuilder(), extensionRegistry);
                            this.bitField0_ |= 2;
                            continue block10;
                        }
                    }
