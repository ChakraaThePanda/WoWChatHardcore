...
implements BytesValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", BytesValue.class.getName());
    ...
    implements BytesValueOrBuilder {
        ...
        private void buildPartial0(BytesValue result2) {
