...
extends GeneratedMessage.ExtendableMessage<GeneratedMessageV3> {
    ...
    extends GeneratedMessage.ExtendableBuilder<GeneratedMessageV3, BuilderT> {
        ...
        @Deprecated
        public BuilderT setField(Descriptors.FieldDescriptor field2, Object value) {
            return (BuilderT)((Builder)super.setField(field2, value));
        }

        @Override
        @Deprecated
        public BuilderT clearField(Descriptors.FieldDescriptor field2) {
            return (BuilderT)((Builder)super.clearField(field2));
        }
        ...
        @Deprecated
        public BuilderT setRepeatedField(Descriptors.FieldDescriptor field2, int index, Object value) {
            return (BuilderT)((Builder)super.setRepeatedField(field2, index, value));
        }

        @Override
        @Deprecated
        public BuilderT addRepeatedField(Descriptors.FieldDescriptor field2, Object value) {
            return (BuilderT)((Builder)super.addRepeatedField(field2, value));
        }
