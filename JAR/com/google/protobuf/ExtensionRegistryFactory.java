...
final class ExtensionRegistryFactory {
    ...
    public static ExtensionRegistryLite create() {
        ExtensionRegistryLite result2 = ExtensionRegistryFactory.invokeSubclassFactory("newInstance");
        return result2 != null ? result2 : new ExtensionRegistryLite();
    }

    public static ExtensionRegistryLite createEmpty() {
        ExtensionRegistryLite result2 = ExtensionRegistryFactory.invokeSubclassFactory("getEmptyRegistry");
        return result2 != null ? result2 : ExtensionRegistryLite.EMPTY_REGISTRY_LITE;
    }
