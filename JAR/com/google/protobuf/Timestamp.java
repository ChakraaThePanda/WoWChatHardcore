...
implements TimestampOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Timestamp.class.getName());
    ...
    implements TimestampOrBuilder {
        ...
        private void buildPartial0(Timestamp result2) {
