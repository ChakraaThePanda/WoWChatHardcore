...
implements EnumValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", EnumValue.class.getName());
    ...
    implements EnumValueOrBuilder {
        ...
        private void buildPartialRepeatedFields(EnumValue result2) {
            if (this.optionsBuilder_ == null) {
        ...
        private void buildPartial0(EnumValue result2) {
