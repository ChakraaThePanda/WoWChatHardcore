...
implements MethodOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 28, 2, "", Method.class.getName());
    ...
    implements MethodOrBuilder {
        ...
        private void buildPartialRepeatedFields(Method result2) {
            if (this.optionsBuilder_ == null) {
        ...
        private void buildPartial0(Method result2) {
