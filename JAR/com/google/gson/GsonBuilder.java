...
public final class GsonBuilder {
    ...
    public GsonBuilder registerTypeAdapter(Type type, Object typeAdapter) {
        ...
        if (typeAdapter instanceof TypeAdapter) {
            TypeAdapterFactory factory2 = TypeAdapters.newFactory(TypeToken.get(type), (TypeAdapter)typeAdapter);
            this.factories.add(factory2);
        }
        return this;
    }

    public GsonBuilder registerTypeAdapterFactory(TypeAdapterFactory factory2) {
    ...
    public GsonBuilder registerTypeHierarchyAdapter(Class<?> baseType, Object typeAdapter) {
        ...
        if (typeAdapter instanceof TypeAdapter) {
            TypeAdapterFactory factory2 = TypeAdapters.newTypeHierarchyFactory(baseType, (TypeAdapter)typeAdapter);
            this.factories.add(factory2);
        }
        return this;
    }
