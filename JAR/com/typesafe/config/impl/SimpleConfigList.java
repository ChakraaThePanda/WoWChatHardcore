...
Serializable {
    ...
    ResolveResult<? extends SimpleConfigList> resolveSubstitutions(ResolveContext context, ResolveSource source2) throws AbstractConfigValue.NotPossibleToResolve {
        if (this.resolved) {
        ...
        try {
            ResolveModifier modifier = new ResolveModifier(context, source2.pushParent(this));
    ...
    implements AbstractConfigValue.Modifier {
        ...
        public AbstractConfigValue modifyChildMayThrow(String key, AbstractConfigValue v) throws AbstractConfigValue.NotPossibleToResolve {
            ResolveResult<? extends AbstractConfigValue> result2 = this.context.resolve(v, this.source);
