...
ExecutionContextTasks {
    ...
    public <R, Tp> R executeAndWaitResult(Task<R, Tp> task) {
        return (R)ExecutionContextTasks.executeAndWaitResult$(this, task);
    }
    ...
    @Override
    public final void scala$collection$parallel$ExecutionContextTasks$_setter_$scala$collection$parallel$ExecutionContextTasks$$driver_$eq(Tasks x$1) {
