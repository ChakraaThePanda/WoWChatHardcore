...
public final class package {
    ...
    public static Option<List<Nothing$>> SomeOfNil() {
    ...
    implements StripMarginInterpolator {
        ...
        @Override
        public final String sm(Seq<Object> args2) {
            return StripMarginInterpolator.sm$(this, args2);
        }
