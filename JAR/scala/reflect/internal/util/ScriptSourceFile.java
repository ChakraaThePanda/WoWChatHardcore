...
extends BatchSourceFile {
    ...
    public Position positionInUltimateSource(Position pos) {
        if (!pos.isDefined()) {
            return super.positionInUltimateSource(pos);
        }
        return pos.withSource(this.underlying).withShift(this.start());
    }
